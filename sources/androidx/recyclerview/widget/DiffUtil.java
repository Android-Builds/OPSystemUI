        ...
        private void findMatchingItems() {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                for (int i7 = 0; i7 < snake.size; i7++) {
                    int i8 = snake.f20x + i7;
                    int i9 = snake.f21y + i7;
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                for (int i6 = i3 - 1; i6 >= 0; i6--) {
                    ...
                    int i7 = snake.f20x;
                    if ((iArr[i7 + i6] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(i7 + i6, 1, this.mCallback.getChangePayload(i7 + i6, snake.f21y + i6));
                    }
                }
                i = snake.f20x;
                i2 = snake.f21y;
    ...
    public static DiffResult calculateDiff(Callback callback, boolean z) {
        ...
        while (!arrayList2.isEmpty()) {
            ...
            if (diffPartial != null) {
                ...
                if (!diffPartial.reverse) {
                    int i2 = diffPartial.f20x;
                    int i3 = diffPartial.size;
                    range.oldListStart = i2 + i3;
                    range.newListStart = diffPartial.f21y + i3;
                } else if (diffPartial.removal) {
                    int i4 = diffPartial.f20x;
                    int i5 = diffPartial.size;
                    range.oldListStart = i4 + i5 + 1;
                    range.newListStart = diffPartial.f21y + i5;
                } else {
                    int i6 = diffPartial.f20x;
                    int i7 = diffPartial.size;
                    range.oldListStart = i6 + i7;
                    range.newListStart = diffPartial.f21y + i7 + 1;
                }
