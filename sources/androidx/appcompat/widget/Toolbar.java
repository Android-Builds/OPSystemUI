...
public class Toolbar extends ViewGroup {
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (parent2 != toolbar3) {
                ...
                generateDefaultLayoutParams.gravity = 8388611 | (toolbar4.mButtonGravity & C0526R.styleable.AppCompatTheme_toolbarNavigationButtonStyle);
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            generateDefaultLayoutParams.gravity = 8388613 | (this.mButtonGravity & C0526R.styleable.AppCompatTheme_toolbarNavigationButtonStyle);
