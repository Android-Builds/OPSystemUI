...
class AppCompatDelegateImpl extends AppCompatDelegate implements Callback, Factory2 {
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder menuBuilder) {
            ...
            if (windowCallback != null) {
                windowCallback.onMenuOpened(C0526R.styleable.AppCompatTheme_textAppearanceSearchResultTitle, menuBuilder);
            }
            return true;
        }
        ...
        this.mInvalidatePanelMenuRunnable = new Runnable() {
            public void run() {
                ...
                if ((appCompatDelegateImpl2.mInvalidatePanelMenuFeatures & 4096) != 0) {
                    appCompatDelegateImpl2.doInvalidatePanelMenu(C0526R.styleable.AppCompatTheme_textAppearanceSearchResultTitle);
                }
                AppCompatDelegateImpl appCompatDelegateImpl3 = AppCompatDelegateImpl.this;
    ...
    private void ensureSubDecor() {
        if (!this.mSubDecorInstalled) {
            ...
            if (panelState == null || panelState.menu == null) {
                invalidatePanelMenu(C0526R.styleable.AppCompatTheme_textAppearanceSearchResultTitle);
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(R$styleable.AppCompatTheme_windowActionBar)) {
            if (obtainStyledAttributes.getBoolean(R$styleable.AppCompatTheme_windowNoTitle, false)) {
                ...
                requestWindowFeature(C0526R.styleable.AppCompatTheme_textAppearanceSearchResultTitle);
            }
            if (obtainStyledAttributes.getBoolean(R$styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(C0526R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu);
            }
            ...
            if (this.mWindowNoTitle) {
                ...
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(C0526R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu);
                }
        ...
        if (!panelFeatureState.isOpen && !this.mIsDestroyed) {
            ...
            if (windowCallback == null || windowCallback.onMenuOpened(panelFeatureState.featureId, panelFeatureState.menu)) {
                ...
                if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
                    if (panelFeatureState.decorView == null || panelFeatureState.refreshDecorView) {
                        ...
                        if (view != null) {
                            ...
                            if (layoutParams2 != null && layoutParams2.width == -1) {
                                ...
                                WindowManager.LayoutParams layoutParams3 = new WindowManager.LayoutParams(i, -2, panelFeatureState.f3x, panelFeatureState.f4y, 1002, 8519680, -3);
                    ...
                    i = -2;
                    panelFeatureState.isHandled = false;
                    WindowManager.LayoutParams layoutParams32 = new WindowManager.LayoutParams(i, -2, panelFeatureState.f3x, panelFeatureState.f4y, 1002, 8519680, -3);
    ...
    private void reopenMenu(MenuBuilder menuBuilder, boolean z) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && z) {
            ...
            if (!this.mIsDestroyed) {
                windowCallback.onPanelClosed(C0526R.styleable.AppCompatTheme_textAppearanceSearchResultTitle, getPanelState(0, true).menu);
            }
            ...
            if (menuBuilder2 != null && !panelState2.refreshMenuContent && windowCallback.onPreparePanel(0, panelState2.createdPanelView, menuBuilder2)) {
                windowCallback.onMenuOpened(C0526R.styleable.AppCompatTheme_textAppearanceSearchResultTitle, panelState2.menu);
    ...
    public void checkCloseActionMenu(MenuBuilder menuBuilder) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback windowCallback = getWindowCallback();
            if (windowCallback != null && !this.mIsDestroyed) {
                windowCallback.onPanelClosed(C0526R.styleable.AppCompatTheme_textAppearanceSearchResultTitle, menuBuilder);
            }
    ...
    private int sanitizeWindowFeatureId(int i) {
        ...
        if (i == 8) {
            ...
            return C0526R.styleable.AppCompatTheme_textAppearanceSearchResultTitle;
        } else if (i != 9) {
            return i;
        } else {
            Log.i(str, "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return C0526R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu;
        }
    }
