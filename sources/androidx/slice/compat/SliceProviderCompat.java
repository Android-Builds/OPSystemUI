...
public class SliceProviderCompat {
    ...
    public Bundle call(String str, String str2, Bundle bundle) {
        ...
        if (str.equals("bind_slice")) {
            ...
            ArraySet specs2 = this.mPinnedList.getSpecs(uri3);
            if (specs2.size() != 0) {
            ...
            bundle7.putInt("result", this.mPermissionManager.checkSlicePermission(uri5, i, i2));
            return bundle7;
        } else {
        ...
        if (queryIntentContentProviders == null || queryIntentContentProviders.isEmpty()) {
            ...
            if (resolveActivity != null) {
                ...
                if (!(activityInfo == null || activityInfo.metaData == null)) {
                    ...
                    if (resolveActivity.activityInfo.metaData.containsKey(str2)) {
    ...
    public static void grantSlicePermission(android.content.Context r2, java.lang.String r3, java.lang.String r4, android.net.Uri r5) {
        /*
            ...
            androidx.slice.compat.SliceProviderCompat$ProviderHolder r2 = acquireClient(r2, r5)     // Catch:{ RemoteException -> 0x003a }
            android.os.Bundle r0 = new android.os.Bundle     // Catch:{ all -> 0x002c }
            r0.<init>()     // Catch:{ all -> 0x002c }
            java.lang.String r1 = "slice_uri"
            r0.putParcelable(r1, r5)     // Catch:{ all -> 0x002c }
            java.lang.String r5 = "provider_pkg"
            r0.putString(r5, r3)     // Catch:{ all -> 0x002c }
            java.lang.String r3 = "pkg"
            r0.putString(r3, r4)     // Catch:{ all -> 0x002c }
            android.content.ContentProviderClient r3 = r2.mProvider     // Catch:{ all -> 0x002c }
            java.lang.String r4 = "grant_perms"
            java.lang.String r5 = "supports_versioned_parcelable"
            r3.call(r4, r5, r0)     // Catch:{ all -> 0x002c }
            if (r2 == 0) goto L_0x0042
            r2.close()     // Catch:{ RemoteException -> 0x003a }
            goto L_0x0042
        L_0x002c:
            r3 = move-exception
        ...
        L_0x0035:
            r2 = move-exception
            r3.addSuppressed(r2)     // Catch:{ RemoteException -> 0x003a }
        L_0x0039:
            throw r4     // Catch:{ RemoteException -> 0x003a }
        L_0x003a:
            r2 = move-exception
