...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationFrameCallback {
    ...
    /* renamed from: X */
    public static final ViewProperty f17X = new ViewProperty("x") {
        public void setValue(View view, float f) {
            view.setX(f);
        }
    ...
    /* renamed from: Y */
    public static final ViewProperty f18Y = new ViewProperty("y") {
        public void setValue(View view, float f) {
            view.setY(f);
        }
    ...
    /* renamed from: Z */
    public static final ViewProperty f19Z = new ViewProperty("z") {
        public void setValue(View view, float f) {
