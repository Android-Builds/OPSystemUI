...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (min > 0) {
            ...
            if (((double) Math.abs(this.f22mX[0])) <= 1.0E-5d && ((double) Math.abs(this.f23mY[0])) <= 1.0E-5d) {
                int i3 = min - 1;
                if (((double) Math.abs(this.f22mX[i3] - 1.0f)) <= 1.0E-5d && ((double) Math.abs(this.f23mY[i3] - 1.0f)) <= 1.0E-5d) {
                    float f = 0.0f;
                    int i4 = 0;
                    while (i < min) {
            ...
            sb2.append(this.f22mX[0]);
            String str = ",";
            sb2.append(str);
            sb2.append(this.f23mY[0]);
            sb2.append(" end:");
            int i6 = min - 1;
            sb2.append(this.f22mX[i6]);
            sb2.append(str);
            sb2.append(this.f23mY[i6]);
