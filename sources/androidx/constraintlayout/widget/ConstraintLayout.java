...
public class ConstraintLayout extends ViewGroup {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (size3 > 0) {
            boolean z5 = this.mLayoutWidget.getHorizontalDimensionBehaviour() == DimensionBehaviour.WRAP_CONTENT;
            boolean z6 = this.mLayoutWidget.getVerticalDimensionBehaviour() == DimensionBehaviour.WRAP_CONTENT;
            ...
            int i19 = 0;
            while (i18 < size3) {
                ConstraintWidget constraintWidget = (ConstraintWidget) this.mVariableDimensionsWidgets.get(i18);
                        ...
                        if (view.getVisibility() != 8 && (!z4 || !constraintWidget.getResolutionWidth().isResolved() || !constraintWidget.getResolutionHeight().isResolved())) {
                            ...
                            if (measuredWidth != constraintWidget.getWidth()) {
                                ...
                                if (z5 && constraintWidget.getRight() > i17) {
                                    i17 = Math.max(i17, constraintWidget.getRight() + constraintWidget.getAnchor(Type.RIGHT).getMargin());
                                }
                                z7 = true;
                            }
                            if (measuredHeight != constraintWidget.getHeight()) {
                                ...
                                if (z6) {
                                    ...
                                    if (constraintWidget.getBottom() > i9) {
                                        max2 = Math.max(i9, constraintWidget.getBottom() + constraintWidget.getAnchor(Type.BOTTOM).getMargin());
                                        z7 = true;
                                    }
                                } else {
                                    i9 = max2;
            ...
            for (int i27 = 0; i27 < i26; i27++) {
                ConstraintWidget constraintWidget2 = (ConstraintWidget) this.mVariableDimensionsWidgets.get(i27);
        ...
        if (VERSION.SDK_INT >= 11) {
            int resolveSizeAndState = ViewGroup.resolveSizeAndState(height2, i11, i3 << 16) & 16777215;
