...
final class GridLayoutManager extends LayoutManager {
    ...
    private Provider mGridProvider = new Provider() {
        ...
        public int createItem(int r6, boolean r7, java.lang.Object[] r8, boolean r9) {
            ...
            L_0x00ca:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.leanback.widget.GridLayoutManager.C03202.createItem(int, boolean, java.lang.Object[], boolean):int");
        }
    ...
    public void layoutChild(int i, View view, int i2, int i3, int i4) {
        ...
        int i10 = i9 & C0526R.styleable.AppCompatTheme_toolbarNavigationButtonStyle;
    ...
    private void fastRelayout() {
        ...
        while (true) {
            ...
            if (i2 != getAdapterPositionByView(childAt)) {
                break;
            }
            Location location = this.mGrid.getLocation(i2);
            if (location == null) {
                break;
            }
    ...
    public void fillScrapViewsInPostLayout() {
        ...
        if (size != 0) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                int adapterPosition = ((ViewHolder) scrapList.get(i2)).getAdapterPosition();
    ...
    public int startPositionSmoothScroller(int i) {
        C03214 r0 = new GridLinearSmoothScroller() {
            public PointF computeScrollVectorForPosition(int i) {
                if (getChildCount() == 0) {
                    return null;
                }
