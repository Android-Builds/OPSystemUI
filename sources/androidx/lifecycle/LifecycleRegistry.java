...
public class LifecycleRegistry extends Lifecycle {
    ...
    static /* synthetic */ class C03481 {
        ...
        static {
            ...
            L_0x0091:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.LifecycleRegistry.C03481.<clinit>():void");
        }
    }
    ...
    private static Event downEvent(State state) {
        int i = C03481.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
        if (i == 1) {
