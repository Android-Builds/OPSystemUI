...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (childCount > i) {
            ...
            if (baseline != -1) {
                ...
                if (this.mOrientation == 1) {
                    int i3 = this.mGravity & C0526R.styleable.AppCompatTheme_toolbarNavigationButtonStyle;
                    if (i3 != 48) {
                        if (i3 == 16) {
    ...
    /* access modifiers changed from: 0000 */
    /* JADX WARNING: Removed duplicated region for block: B:182:0x044c  */
    ...
    public void layoutVertical(int i, int i2, int i3, int i4) {
        ...
        int i12 = i11 & C0526R.styleable.AppCompatTheme_toolbarNavigationButtonStyle;
        int i13 = i11 & 8388615;
        if (i12 == 16) {
    ...
    public void layoutHorizontal(int r25, int r26, int r27, int r28) {
        /*
            r24 = this;
            r6 = r24
            boolean r0 = android.support.p002v7.widget.ViewUtils.isLayoutRtl(r24)
        ...
        L_0x0080:
            ...
            r4 = r18
            android.support.v7.widget.LinearLayoutCompat$LayoutParams r4 = (android.support.p002v7.widget.LinearLayoutCompat.LayoutParams) r4
            r18 = r3
    ...
    public void setGravity(int i) {
        if (this.mGravity != i) {
            ...
            if ((i & C0526R.styleable.AppCompatTheme_toolbarNavigationButtonStyle) == 0) {
                i |= 48;
            }
            this.mGravity = i;
            requestLayout();
