...
public class KeyguardSliceView extends LinearLayout implements OnClickListener, Observer<Slice>, Tunable, ConfigurationListener {
    ...
    @VisibleForTesting
    static class KeyguardSliceButton extends Button implements ConfigurationListener {
        ...
        public void onDensityOrFontScaleChanged() {
            updatePadding();
            setTextSize(0, (float) getResources().getDimensionPixelSize(R$dimen.op_owner_info_font_size));
        }
    ...
    public void onFinishInflate() {
        ...
        this.mRowTextSize = (float) this.mContext.getResources().getDimensionPixelSize(R$dimen.op_owner_info_font_size);
        this.mRowWithHeaderTextSize = (float) this.mContext.getResources().getDimensionPixelSize(R$dimen.header_row_font_size);
    ...
    private void showSlice() {
        ...
        for (int i4 = this.mHasHeader; i4 < size; i4++) {
            ...
            if (OpUtils.isMCLVersionFont()) {
                ...
                if (mclTypeface != null) {
                    keyguardSliceButton.setTypeface(mclTypeface);
                }
            }
        }
