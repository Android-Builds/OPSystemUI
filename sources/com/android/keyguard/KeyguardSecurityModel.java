...
public class KeyguardSecurityModel {
    ...
    private final boolean mIsPukScreenAvailable = this.mContext.getResources().getBoolean(17891456);
    ...
    public SecurityMode getSecurityMode(int i) {
        ...
        if (this.mIsPukScreenAvailable && SubscriptionManager.isValidSubscriptionId(instance.getNextSubIdForState(State.PUK_REQUIRED))) {
            return SecurityMode.SimPuk;
        }
        if (SubscriptionManager.isValidSubscriptionId(instance.getNextSubIdForState(State.PIN_REQUIRED))) {
