...
public class KeyguardEsimArea extends Button implements OnClickListener {
            ...
            public void onReceive(Context context, Intent intent) {
                if ("com.android.keyguard.disable_esim".equals(intent.getAction())) {
                    ...
                    if (resultCode != 0) {
                        ...
                        AlertDialog create = new Builder(KeyguardEsimArea.this.mContext).setMessage(R$string.error_disable_esim_msg).setTitle(R$string.error_disable_esim_title).setCancelable(false).setPositiveButton(R$string.f53ok, null).create();
