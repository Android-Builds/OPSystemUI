...
public class KeyguardClockSwitch extends RelativeLayout {
    ...
    private class ClockVisibilityTransition extends Visibility {
        ...
        private Animator createAnimator(final View view, float f, final int i, final int i2, float f2, float f3) {
            ...
            C0547x69bf1505 r1 = new AnimatorUpdateListener(f, view, i2, f2, f3) {
    ...
    public void setKeyguardShowingHeader(boolean z) {
        if (this.mShowingHeader != z && !hasCustomClock()) {
            ...
            float dimensionPixelSize = (float) this.mContext.getResources().getDimensionPixelSize(R$dimen.widget_small_font_size);
            float dimensionPixelSize2 = (float) this.mContext.getResources().getDimensionPixelSize(OpUtils.isMCLVersion() ? R$dimen.oneplus_widget_big_font_size_mcl : R$dimen.oneplus_widget_big_font_size);
            ...
            int dimensionPixelSize3 = this.mContext.getResources().getDimensionPixelSize(z ? R$dimen.widget_vertical_padding_clock : R$dimen.title_clock_padding);
