...
public class KeyguardDisplayManager {
    ...
    private final DisplayListener mDisplayListener = new DisplayListener() {
        ...
        public void onDisplayChanged(int i) {
            if (i != 0) {
                Display display = KeyguardDisplayManager.this.mDisplayService.getDisplay(i);
                if (display != null && KeyguardDisplayManager.this.mShowing) {
                    Presentation presentation = (Presentation) KeyguardDisplayManager.this.mPresentations.get(i);
    ...
    static final class KeyguardPresentation extends Presentation {
        ...
        public void onCreate(Bundle bundle) {
            ...
            setContentView(this.mInjectableInflater.injectable(LayoutInflater.from(getContext())).inflate(R$layout.keyguard_presentation, null));
