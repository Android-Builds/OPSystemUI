...
import com.android.systemui.statusbar.phone.HighlightHintControllerImpl;
...
public class Dependency extends SystemUI {
    ...
    public void start() {
        ...
        Lazy<TunablePaddingService> lazy49 = this.mTunablePaddingService;
        ...
        Lazy<WarningsUI> lazy52 = this.mWarningsUI;
        ...
        Lazy<KeyguardEnvironment> lazy62 = this.mKeyguardEnvironment;
        ...
        Lazy<Callback> lazy64 = this.mNotificationRemoteInputManagerCallback;
        ...
        Lazy<AmbientPulseManager> lazy75 = this.mAmbientPulseManager;
        Objects.requireNonNull(lazy75);
        this.mProviders.put(AmbientPulseManager.class, new LazyDependencyCreator() {
            public final Object createDependency() {
                return Lazy.this.get();
            }
        });
        ...
        Lazy<NotificationInterruptionStateProvider> lazy83 = this.mNotificationInterruptionStateProvider;
        ...
        Lazy<KeyguardDismissUtil> lazy84 = this.mKeyguardDismissUtil;
        ...
        Lazy<SmartReplyController> lazy85 = this.mSmartReplyController;
        ...
        Lazy<RemoteInputQuickSettingsDisabler> lazy86 = this.mRemoteInputQuickSettingsDisabler;
        ...
        Lazy<BubbleController> lazy87 = this.mBubbleController;
        ...
        Lazy<NotificationEntryManager> lazy88 = this.mNotificationEntryManager;
        ...
        Lazy<NotificationAlertingManager> lazy89 = this.mNotificationAlertingManager;
        ...
        Lazy<AutoHideController> lazy101 = this.mAutoHideController;
        ...
        if (OpUtils.isSupportSOCThreekey()) {
            Lazy<OpZenModeController> lazy102 = this.mOpZenModeController;
            Objects.requireNonNull(lazy102);
            this.mProviders.put(OpZenModeController.class, new LazyDependencyCreator() {
                public final Object createDependency() {
                    return Lazy.this.get();
                }
            });
        }
        Lazy<OpChargingAnimationController> lazy103 = this.mOpChargingAnimationController;
        Objects.requireNonNull(lazy103);
        this.mProviders.put(OpChargingAnimationController.class, new LazyDependencyCreator() {
            public final Object createDependency() {
                return Lazy.this.get();
            }
        });
        this.mProviders.put(HighlightHintController.class, $$Lambda$Dependency$s5n910hBKehmAZcflbckfnf87NE.INSTANCE);
        Lazy<NetworkSpeedController> lazy104 = this.mOpNetworkSpeedController;
        ...
        Lazy<OpNotificationController> lazy105 = this.mOpNotificationController;
        Objects.requireNonNull(lazy105);
        this.mProviders.put(OpNotificationController.class, new LazyDependencyCreator() {
            public final Object createDependency() {
                return Lazy.this.get();
            }
        });
        Lazy<OpSceneModeObserver> lazy106 = this.mOpSceneModeObserver;
        Objects.requireNonNull(lazy106);
        this.mProviders.put(OpSceneModeObserver.class, new LazyDependencyCreator() {
            public final Object createDependency() {
                return Lazy.this.get();
            }
        });
        this.mProviders.put(WLBSwitchController.class, new LazyDependencyCreator() {
            public Object createDependency() {
                return new WLBSwitchController(Dependency.this.mContext);
            }
        });
        sDependency = this;
    }
    ...
    static /* synthetic */ Object lambda$start$0() {
        return new HighlightHintControllerImpl();
    }
    ...
    public synchronized void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        this.mDependencies.values().stream().filter(new Predicate(lowerCase) {
            ...
            public final boolean test(Object obj) {
                return Dependency.lambda$dump$1(this.f$0, obj);
            }
    ...
    static /* synthetic */ boolean lambda$dump$1(String str, Object obj) {
    ...
    public synchronized void onConfigurationChanged(Configuration configuration) {
        ...
        Log.d("Dependency", "onConfigurationChanged, call back to registered receivers");
        this.mDependencies.values().stream().filter($$Lambda$Dependency$6A82rtcjkm95tb550T45blueZwM.INSTANCE).forEach(new Consumer(configuration) {
    ...
    static /* synthetic */ boolean lambda$onConfigurationChanged$3(Object obj) {
    ...
    public static <T> T get(Class<T> cls) {
        ...
        return dependency.getDependency(cls);
    }
    ...
    public static <T> T get(DependencyKey<T> dependencyKey) {
        ...
        return dependency.getDependency(dependencyKey);
    }
}
