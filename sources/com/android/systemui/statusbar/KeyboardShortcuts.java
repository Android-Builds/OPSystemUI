...
public final class KeyboardShortcuts {
    ...
    private void loadResources(Context context) {
        ...
        this.mSpecialCharacterNames.put(C0526R.styleable.AppCompatTheme_switchStyle, context.getString(R$string.keyboard_key_button_template, new Object[]{"Z"}));
        this.mSpecialCharacterNames.put(C0526R.styleable.AppCompatTheme_textAppearanceLargePopupMenu, context.getString(R$string.keyboard_key_button_template, new Object[]{"L1"}));
        this.mSpecialCharacterNames.put(C0526R.styleable.AppCompatTheme_textAppearanceListItem, context.getString(R$string.keyboard_key_button_template, new Object[]{"R1"}));
        this.mSpecialCharacterNames.put(C0526R.styleable.AppCompatTheme_textAppearanceListItemSecondary, context.getString(R$string.keyboard_key_button_template, new Object[]{"L2"}));
        this.mSpecialCharacterNames.put(C0526R.styleable.AppCompatTheme_textAppearanceListItemSmall, context.getString(R$string.keyboard_key_button_template, new Object[]{"R2"}));
        this.mSpecialCharacterNames.put(C0526R.styleable.AppCompatTheme_textAppearanceSearchResultTitle, context.getString(R$string.keyboard_key_button_template, new Object[]{"Start"}));
        this.mSpecialCharacterNames.put(C0526R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu, context.getString(R$string.keyboard_key_button_template, new Object[]{"Select"}));
        this.mSpecialCharacterNames.put(C0526R.styleable.AppCompatTheme_textColorAlertDialogListItem, context.getString(R$string.keyboard_key_button_template, new Object[]{"Mode"}));
        this.mSpecialCharacterNames.put(C0526R.styleable.AppCompatTheme_toolbarNavigationButtonStyle, context.getString(R$string.keyboard_key_forward_del));
        this.mSpecialCharacterNames.put(C0526R.styleable.AppCompatTheme_textColorSearchUrl, "Esc");
        ...
        this.mSpecialCharacterNames.put(158, context.getString(R$string.keyboard_key_numpad_template, new Object[]{str}));
    ...
    public void handleShowKeyboardShortcuts(List<KeyboardShortcutGroup> list) {
        ...
        View inflate = ((LayoutInflater) this.mContext.getSystemService("layout_inflater")).inflate(R$layout.keyboard_shortcuts_view, null);
        ...
        while (i9 < size) {
            ...
            while (i10 < size2) {
                ...
                if (humanReadableShortcutKeys == null) {
                    ...
                    View inflate = from.inflate(R$layout.keyboard_shortcut_app_item, linearLayout3, z3);
