...
public class NotificationShelf extends OpNotificationShelf implements OnLayoutChangeListener, StateListener {
    ...
    private void initDimens() {
        ...
        this.mDarkShelfPadding = (float) resources.getDimensionPixelSize(R$dimen.widget_bottom_separator_padding);
        ...
        this.mDarkShelfIconSize = (float) resources.getDimensionPixelOffset(R$dimen.dark_shelf_icon_size);
    ...
    private void updateContinuousClipping(final ExpandableNotificationRow expandableNotificationRow) {
        ...
        if (z2 && !z) {
            ...
            final C11951 r2 = new OnPreDrawListener() {
            ...
            statusBarIconView.addOnAttachStateChangeListener(new OnAttachStateChangeListener() {
    ...
    private float updateIconAppearance(ExpandableNotificationRow expandableNotificationRow, float f, boolean z, boolean z2, boolean z3, boolean z4) {
        float f2;
        float f3 = f;
        IconState iconState = getIconState(expandableNotificationRow.getEntry().expandedIcon);
        if (iconState == null) {
            return 0.0f;
        }
        float translationY = expandableNotificationRow.getTranslationY();
    ...
    private void updateIconPositioning(ExpandableNotificationRow expandableNotificationRow, float f, float f2, float f3, boolean z, boolean z2, boolean z3, boolean z4) {
        boolean z5 = z4;
        StatusBarIconView statusBarIconView = expandableNotificationRow.getEntry().expandedIcon;
        IconState iconState = getIconState(statusBarIconView);
        if (iconState != null) {
            boolean z6 = false;
            ...
            if (expandableNotificationRow.isAboveShelf() || (!z5 && !iconState.translateContent)) {
                ExpandableNotificationRow expandableNotificationRow2 = expandableNotificationRow;
            } else {
    ...
    private void setIconTransformationAmount(ExpandableNotificationRow expandableNotificationRow, float f, float f2, boolean z, boolean z2) {
        ...
        float f6 = this.mDark ? this.mDarkShelfIconSize : (float) this.mIconSize;
    ...
    public boolean needsOutline() {
        return !this.mHideBackground && !this.mDark && super.needsOutline();
    }

    /* access modifiers changed from: protected */
    public boolean shouldHideBackground() {
        return super.shouldHideBackground() || this.mHideBackground || this.mDark;
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.mInteractive) {
            ...
            accessibilityNodeInfo.addAction(new AccessibilityAction(16, getContext().getString(R$string.accessibility_overflow_action)));
        }
    }
