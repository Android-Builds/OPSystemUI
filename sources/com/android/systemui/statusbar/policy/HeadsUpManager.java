...
public abstract class HeadsUpManager extends OpHeadsUpManager {
    ...
    protected class HeadsUpEntry extends AlertEntry {
        ...
        private int getRecommendedTimeoutMillis() {
            return HeadsUpManager.this.mAccessibilityMgr.getRecommendedTimeoutMillis(HeadsUpManager.this.mAutoDismissNotificationDecay, 7);
        }
    }
    ...
    public HeadsUpManager(final Context context) {
        ...
        this.mSnoozeLengthMs = Global.getInt(context.getContentResolver(), str, resources.getInteger(R$integer.heads_up_default_snooze_length_ms));
    ...
    public void snooze() {
        for (String headsUpEntry : this.mAlertEntries.keySet()) {
            ...
            this.mSnoozedPackages.put(snoozeKey(headsUpEntry2.mEntry.notification.getPackageName(), this.mUser), Long.valueOf(this.mClock.currentTimeMillis() + ((long) this.mSnoozeLengthMs)));
            super.snoozeAlertEntry(headsUpEntry2);
        }
    }
