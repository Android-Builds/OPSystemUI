...
public interface NetworkController extends CallbackController<SignalCallback>, DemoMode {
    ...
    public interface SignalCallback {
        ...
        void setHasAnySimReady(boolean z) {
        }

        void setIsAirplaneMode(IconState iconState) {
        }

        void setLTEStatus(IconState[] iconStateArr) {
        }

        void setMobileDataEnabled(boolean z) {
        }

        void setMobileDataIndicators(IconState iconState, IconState iconState2, int i, int i2, boolean z, boolean z2, int i3, int[] iArr, int[] iArr2, String str, String str2, boolean z3, int i4, boolean z4, boolean z5) {
        }

        void setNoSims(boolean z, boolean z2) {
        }

        void setProvision(int i, int i2) {
        }

        void setSubs(List<SubscriptionInfo> list) {
        }

        void setTetherError(Intent intent) {
        }

        void setVirtualSimstate(int[] iArr) {
        }
