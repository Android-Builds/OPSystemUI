...
public class UserInfoControllerImpl implements UserInfoController {
    ...
    private void queryForUserInformation() {
        ...
        try {
            ...
            C16373 r6 = new AsyncTask<Void, Void, UserInfoQueryResult>() {
                ...
                public UserInfoQueryResult doInBackground(Void... voidArr) {
                    ...
                    if (userIcon != null) {
                        ...
                        drawable = UserIcons.getDefaultUserIcon(createPackageContextAsUser.getResources(), isGuest ? -10000 : i, false);
                    }
