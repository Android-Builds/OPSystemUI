...
public final class NotificationWakeUpCoordinator implements OnAmbientChangedListener, StateListener {
    ...
    private final void handleAnimationFinished() {
        if (this.mLinearDozeAmount == 0.0f || this.mLinearVisibilityAmount == 0.0f) {
            for (NotificationEntry ambientGoingAway : this.mEntrySetToClearWhenFinished) {
                ambientGoingAway.setAmbientGoingAway(false);
            }
