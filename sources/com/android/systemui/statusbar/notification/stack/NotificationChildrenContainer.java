...
public class NotificationChildrenContainer extends ViewGroup {
    ...
    static {
        C13051 r0 = new AnimationProperties() {
    ...
    private void initDimens() {
        ...
        this.mCollapsedBottompadding = (float) resources.getDimensionPixelSize(17105306);
        ...
        this.mTranslationForHeader = resources.getDimensionPixelSize(17105306) - this.mNotificationHeaderMargin;
    ...
    public void onMeasure(int r18, int r19) {
        ...
        L_0x0097:
            ...
            int r14 = java.lang.Math.min(r14, r9)
        L_0x009f:
        ...
        L_0x00ac:
            ...
            r3.measure(r1, r2)
        L_0x00bb:
            r0.setMeasuredDimension(r8, r14)
            return
        */
    ...
    public void recreateNotificationHeader(OnClickListener onClickListener) {
        ...
        Builder recoverBuilder = Builder.recoverBuilder(getContext(), this.mContainingNotification.getStatusBarNotification().getNotification());
        ...
        if (this.mNotificationHeader == null) {
            ...
            this.mNotificationHeader.findViewById(16908898).setVisibility(0);
    ...
    private void recreateLowPriorityHeader(Builder builder) {
        ...
        if (this.mIsLowPriority) {
            if (builder == null) {
                builder = Builder.recoverBuilder(getContext(), statusBarNotification.getNotification());
            }
            ...
            if (this.mNotificationHeaderLowPriority == null) {
                ...
                this.mNotificationHeaderLowPriority.findViewById(16908898).setVisibility(0);
    ...
    private int getIntrinsicHeight(float f) {
        ...
        for (int i5 = 0; i5 < size && ((float) i4) < f; i5++) {
            ...
            i3 = i + ((ExpandableNotificationRow) this.mChildren.get(i5)).getIntrinsicHeight();
            i4++;
        }
        if (this.mUserLocked) {
            f2 = (float) i3;
    ...
    /* JADX WARNING: type inference failed for: r3v12, types: [android.view.View] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:82:0x010d A[SYNTHETIC] */
    ...
    public int getMaxAllowedVisibleChildren(boolean z) {
        if (z || ((!this.mChildrenExpanded && !this.mContainingNotification.isUserLocked()) || showingAsLowPriority())) {
            return (this.mIsLowPriority || (!this.mContainingNotification.isOnKeyguard() && (this.mContainingNotification.isExpanded() || this.mContainingNotification.isHeadsUp()))) ? 5 : 2;
        }
        return 8;
    }
    ...
    public int getMaxContentHeight() {
        ...
        for (int i5 = 0; i5 < size && i4 < 8; i5++) {
            ExpandableNotificationRow expandableNotificationRow = (ExpandableNotificationRow) this.mChildren.get(i5);
