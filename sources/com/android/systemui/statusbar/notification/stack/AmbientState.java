...
public class AmbientState {
    ...
    public AmbientState(Context context, SectionProvider sectionProvider) {
    ...
    public boolean hasPulsingNotifications() {
        if (this.mPulsing) {
            AmbientPulseManager ambientPulseManager = this.mAmbientPulseManager;
            if (ambientPulseManager != null && ambientPulseManager.hasNotifications()) {
                return true;
            }
        }
        return false;
