        ...
        if (f2 == null || f2.floatValue() != f3) {
            ...
            if (!animationProperties.getAnimationFilter().animateZ) {
                if (objectAnimator != null) {
                    ...
                    if (Float.isNaN(floatValue2) || Float.isNaN(f3)) {
                        StringBuilder sb = new StringBuilder();
                        sb.append(" startZTranslationAnimation:");
                        ...
                        Log.w("ViewState", sb.toString());
                    }
                    values[0].setFloatValues(new float[]{floatValue2, f3});
                    view.setTag(TAG_START_TRANSLATION_Z, Float.valueOf(floatValue2));
