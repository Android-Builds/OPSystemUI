...
public class NotificationLogger implements StateListener {
    ...
    protected final Runnable mVisibilityReporter = new Runnable() {
        ...
        public void run() {
            ...
            ArrayList activeNotifications = NotificationLogger.this.mEntryManager.getNotificationData().getActiveNotifications();
    ...
    public static class ExpansionStateLogger {
        ...
        public void onVisibilityChanged(Collection<NotificationVisibility> collection, Collection<NotificationVisibility> collection2) {
            ...
            for (NotificationVisibility notificationVisibility : access$900) {
                ...
                state.mIsVisible = Boolean.valueOf(true);
            ...
            for (NotificationVisibility notificationVisibility2 : access$9002) {
                getState(notificationVisibility2.key).mIsVisible = Boolean.valueOf(false);
            }
        }
            ...
            if (state.isFullySet() && state.mIsVisible.booleanValue()) {
                ...
                if (bool == null || state.mIsExpanded != bool) {
                    ...
                    this.mUiOffloadThread.submit(new Runnable(str, new State(state)) {
                        ...
                        private final /* synthetic */ State f$2;
                        ...
                        public final void run() {
                            ExpansionStateLogger.this.mo15684x167b4926(this.f$1, this.f$2);
                        }
                    });
                }
            }
        ...
        public /* synthetic */ void mo15684x167b4926(String str, State state) {
            try {
