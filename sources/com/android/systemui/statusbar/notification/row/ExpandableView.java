    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (i6 != -1) {
                    int i7 = i6 >= 0 ? i6 > i3 ? MeasureSpec.makeMeasureSpec(i3, 1073741824) : MeasureSpec.makeMeasureSpec(i6, 1073741824) : makeMeasureSpec;
                    childAt.measure(FrameLayout.getChildMeasureSpec(i, paddingStart, layoutParams.width), i7);
