...
public class NotificationMenuRow implements NotificationMenuRowPlugin, OnClickListener, LayoutListener {
    ...
    static MenuItem createSnoozeItem(Context context) {
        return new NotificationMenuItem(context, context.getResources().getString(R$string.notification_menu_snooze_description), (NotificationSnooze) LayoutInflater.from(context).inflate(R$layout.notification_snooze, null, false), R$drawable.ic_snooze);
    }

    static NotificationMenuItem createInfoItem(Context context) {
        return new NotificationMenuItem(context, context.getResources().getString(R$string.notification_menu_gear_description), (NotificationInfo) LayoutInflater.from(context).inflate(R$layout.notification_info, null, false), R$drawable.op_ic_settings);
    }
    ...
    static NotificationMenuItem createInfoItem(Context context, boolean z) {
        ...
        NotificationInfo notificationInfo = (NotificationInfo) LayoutInflater.from(context).inflate(R$layout.notification_info, null, false);
        if (z) {
            i = R$drawable.ic_notifications_silence;
        } else {
            i = R$drawable.ic_notifications_alert;
        }
        return new NotificationMenuItem(context, string, notificationInfo, i);
    }

    static MenuItem createAppOpsItem(Context context) {
        return new NotificationMenuItem(context, null, (AppOpsInfo) LayoutInflater.from(context).inflate(R$layout.app_ops_info, null, false), -1);
    }
