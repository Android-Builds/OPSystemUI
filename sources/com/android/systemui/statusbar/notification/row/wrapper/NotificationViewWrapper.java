...
public abstract class NotificationViewWrapper implements TransformableView {
        ...
        if (view.getId() == 16909407) {
            ...
            if (!"media".equals(view.getTag())) {
                if (!"bigMediaNarrow".equals(view.getTag())) {
                    ...
                    if (DecoratedCustomViewStyle.class.equals(expandableNotificationRow.getEntry().notification.getNotification().getNotificationStyle())) {
    ...
    public void onReinflated() {
        if (this.mRow.getEntry() == null || this.mRow.getEntry().notification == null || this.mRow.getEntry().notification.getNotification() == null || this.mRow.getEntry().notification.getNotification().extras == null || !this.mRow.getEntry().notification.getNotification().extras.getBoolean("op_disable_inversion")) {
        ...
        sb.append("onReinflated, skip for key: ");
        sb.append(this.mRow.getEntry().key);
        Log.d("NotificationViewWrapper", sb.toString());
    }
    ...
    public boolean needsInversion(int i, View view) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("needsInversion, skip for key: ");
        sb.append(this.mRow.getEntry().key);
        Log.d("NotificationViewWrapper", sb.toString());
        return false;
    }
