...
public class NotificationHeaderViewWrapper extends NotificationViewWrapper {
    ...
    public void resolveHeaderViews() {
        ...
        this.mHeaderText = (TextView) this.mView.findViewById(16908977);
        this.mExpandButton = this.mView.findViewById(16908898);
        this.mWorkProfileImage = (ImageView) this.mView.findViewById(16909258);
        this.mNotificationHeader = this.mView.findViewById(16909164);
