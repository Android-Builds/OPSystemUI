...
public class NotificationSnooze extends LinearLayout implements GutsContent, OnClickListener {
    ...
    public class NotificationSnoozeOption implements SnoozeOption {
        ...
        public NotificationSnoozeOption(SnoozeCriterion snoozeCriterion, int i, CharSequence charSequence, CharSequence charSequence2, AccessibilityAction accessibilityAction) {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_snooze_undo, getResources().getString(R$string.snooze_undo)));
    ...
    public void setSnoozeOptions(List<SnoozeCriterion> list) {
        if (list != null) {
            ...
            for (int i = 0; i < min; i++) {
                ...
                AccessibilityAction accessibilityAction = new AccessibilityAction(R$id.action_snooze_assistant_suggestion_1, snoozeCriterion.getExplanation());
                List<SnoozeOption> list2 = this.mSnoozeOptions;
                NotificationSnoozeOption notificationSnoozeOption = new NotificationSnoozeOption(snoozeCriterion, 0, snoozeCriterion.getExplanation(), snoozeCriterion.getConfirmation(), accessibilityAction);
    ...
    private SnoozeOption createOption(int i, int i2) {
        ...
        if (indexOf == -1) {
            NotificationSnoozeOption notificationSnoozeOption = new NotificationSnoozeOption(null, i, quantityString, format, accessibilityAction);
        ...
        NotificationSnoozeOption notificationSnoozeOption2 = new NotificationSnoozeOption(null, i, quantityString, spannableString, accessibilityAction);
    ...
    private void showSnoozeOptions(boolean z) {
        this.mExpandButton.setImageResource(z ? 17302347 : 17302407);
        if (this.mExpanded != z) {
            this.mExpanded = z;
