...
public abstract class ActivatableNotificationView extends ExpandableOutlineView {
    ...
    public ActivatableNotificationView(Context context, AttributeSet attributeSet) {
        ...
        DoubleTapHelper doubleTapHelper = new DoubleTapHelper(this, r2, r3, r4, new DoubleTapLogListener() {
    ...
    private void initDimens() {
        this.mHeadsUpAddStartLocation = getResources().getDimensionPixelSize(17105308);
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.mNeedsDimming || isTouchExplorationEnabled() || !isInteractive()) {
            ...
            z = handleTouchEventDimmed(motionEvent);
            if (z2 && z && motionEvent.getAction() == 1) {
    ...
    private void startActivateAnimation(final boolean z) {
        ...
        if (isAttachedToWindow() && isDimmable()) {
            ...
            animate.alpha(f).setInterpolator(interpolator).setUpdateListener(new AnimatorUpdateListener() {
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
