        ...
        private void setSubSlot(StatusBarIconHolder statusBarIconHolder, int i) {
            if (this.mSubSlots == null) {
                ...
                if (statusBarIconHolder.getType() == 2) {
                    Collections.sort(this.mSubSlots, new Comparator<StatusBarIconHolder>() {
                        public int compare(StatusBarIconHolder statusBarIconHolder, StatusBarIconHolder statusBarIconHolder2) {
                            MobileIconState mobileState = statusBarIconHolder.getMobileState();
                            MobileIconState mobileState2 = statusBarIconHolder2.getMobileState();
                            if (mobileState == null || mobileState2 == null) {
                                return 0;
                            }
                            int i = mobileState.phoneId;
                            int i2 = mobileState2.phoneId;
                            return i == i2 ? mobileState2.subId - mobileState.subId : i2 - i;
                        }
                    });
                }
            }
