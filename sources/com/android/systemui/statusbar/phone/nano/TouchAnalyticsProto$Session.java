...
public final class TouchAnalyticsProto$Session extends MessageNano {
    ...
    public static final class TouchEvent extends MessageNano {
        ...
        public static final class Pointer extends MessageNano {
            ...
            public void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
                if (Float.floatToIntBits(this.f97x) != Float.floatToIntBits(0.0f)) {
                    codedOutputByteBufferNano.writeFloat(1, this.f97x);
                }
                if (Float.floatToIntBits(this.f98y) != Float.floatToIntBits(0.0f)) {
                    codedOutputByteBufferNano.writeFloat(2, this.f98y);
                }
            ...
            public int computeSerializedSize() {
                int computeSerializedSize = super.computeSerializedSize();
                if (Float.floatToIntBits(this.f97x) != Float.floatToIntBits(0.0f)) {
                    computeSerializedSize += CodedOutputByteBufferNano.computeFloatSize(1, this.f97x);
                }
                if (Float.floatToIntBits(this.f98y) != Float.floatToIntBits(0.0f)) {
                    computeSerializedSize += CodedOutputByteBufferNano.computeFloatSize(2, this.f98y);
                }
                if (Float.floatToIntBits(this.size) != Float.floatToIntBits(0.0f)) {
