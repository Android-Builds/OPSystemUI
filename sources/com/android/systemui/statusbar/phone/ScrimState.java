...
public enum ScrimState {
    ...
    BOUNCER(1) {
        ...
        public void applyOpAlphaValue() {
            this.mCurrentInFrontAlpha = ScrimController.ONEPLUS_GRADIENT_SCRIM_ALPHA_BUSY;
        }
    },
    BOUNCER_SCRIMMED(2) {
        public void prepare(ScrimState scrimState) {
    ...
    UNLOCKED(6) {
        public void prepare(ScrimState scrimState) {
            this.mCurrentBehindAlpha = 0.0f;
            this.mCurrentInFrontAlpha = 0.0f;
            if (OpLsState.getInstance().getBiometricUnlockController().getMode() != 5 || !OpUtils.isHomeApp()) {
