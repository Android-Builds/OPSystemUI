...
public class DemoStatusIcons extends StatusIconContainer implements DemoMode, DarkReceiver {
    ...
    public void dispatchDemoCommand(String str, Bundle bundle) {
        ...
        if (!this.mDemoMode && str.equals("enter")) {
            ...
            if (string != null) {
                updateSlot(str2, null, string.equals("vibrate") ? R$drawable.stat_sys_ringer_vibrate : 0);
            }
            String str3 = "zen";
            String string2 = bundle.getString(str3);
            if (string2 != null) {
                updateSlot(str3, null, string2.equals("dnd") ? R$drawable.stat_sys_dnd : 0);
            }
            String str4 = "bluetooth";
            String string3 = bundle.getString(str4);
            if (string3 != null) {
                updateSlot(str4, null, string3.equals("connected") ? R$drawable.stat_sys_data_bluetooth_connected : 0);
            }
            String str5 = "location";
            String string4 = bundle.getString(str5);
            String str6 = "show";
            if (string4 != null) {
                updateSlot(str5, null, string4.equals(str6) ? PhoneStatusBarPolicy.LOCATION_STATUS_ICON_ID : 0);
            }
            String string5 = bundle.getString("alarm");
            if (string5 != null) {
                updateSlot("alarm_clock", null, string5.equals(str6) ? R$drawable.stat_sys_alarm : 0);
            }
            String str7 = "tty";
            String string6 = bundle.getString(str7);
            if (string6 != null) {
                updateSlot(str7, null, string6.equals(str6) ? R$drawable.stat_sys_tty_mode : 0);
            }
            String str8 = "mute";
            ...
            if (string9 != null) {
                updateSlot(str10, null, string9.equals(str6) ? R$drawable.stat_sys_cast : 0);
            }
            String str11 = "hotspot";
            String string10 = bundle.getString(str11);
            if (string10 != null) {
                updateSlot(str11, null, string10.equals(str6) ? R$drawable.stat_sys_hotspot : 0);
            }
            String str12 = "volte";
            String string11 = bundle.getString(str12);
            if (string11 != null) {
                int i2 = string11.equals(str6) ? R$drawable.stat_sys_volte : string11.equals("show1") ? R$drawable.stat_sys_volte_slot1 : string11.equals("show2") ? R$drawable.stat_sys_volte_slot2 : string11.equals("show12") ? R$drawable.stat_sys_volte_slot12 : 0;
                updateSlot(str12, null, i2);
            }
            String str13 = "vowifi";
            String string12 = bundle.getString(str13);
            if (string12 != null) {
                if (string12.equals(str6)) {
                    i = R$drawable.stat_sys_vowifi;
                } else if (string12.equals("show1")) {
                    i = R$drawable.stat_sys_vowifi_slot1;
                } else if (string12.equals("show2")) {
                    i = R$drawable.stat_sys_vowifi_slot2;
                } else if (string12.equals("show12")) {
                    i = R$drawable.stat_sys_vowifi_slot12;
                }
                updateSlot(str13, null, i);
            }
        }
    }
