...
public class StatusBarIconControllerImpl extends StatusBarIconList implements Tunable, ConfigurationListener, Dumpable, Callbacks, StatusBarIconController {
    ...
    public StatusBarIconControllerImpl(Context context) {
        super(context.getResources().getStringArray(17236112));
    ...
    public void onTuningChanged(String str, String str2) {
        if ("icon_blacklist".equals(str)) {
            ...
            if (darkIconDispatcher != null) {
                View traceView = darkIconDispatcher.getTraceView();
                if (traceView != null) {
        ...
        for (MobileIconState mobileIconState : list) {
            ...
            if (holderForTag == null) {
                ...
                if (OpUtils.DEBUG_ONEPLUS) {
                    ...
                    sb.append("setMobileIcons new holder");
                    sb.append(slotIndex);
                    Log.d("StatusBarIconController", sb.toString());
                }
    ...
    public void setExternalIcon(String str) {
        this.mIconGroups.forEach(new Consumer(getViewIndex(getSlotIndex(str), 0), this.mContext.getResources().getDimensionPixelSize(R$dimen.status_bar_icon_drawing_size)) {
            private final /* synthetic */ int f$0;
