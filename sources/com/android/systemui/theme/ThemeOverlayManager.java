...
class ThemeOverlayManager {
    ...
    ThemeOverlayManager(OverlayManager overlayManager, Executor executor, String str, String str2) {
        ...
        String str3 = OVERLAY_CATEGORY_ICON_ANDROID;
        String str4 = OVERLAY_CATEGORY_SHAPE;
        String str5 = OVERLAY_CATEGORY_FONT;
        String str6 = OVERLAY_CATEGORY_COLOR;
        HashSet newHashSet = Sets.newHashSet(new String[]{str6, str5, str4, str3});
    ...
    public /* synthetic */ void lambda$setEnabledAsync$7$ThemeOverlayManager(String str, UserHandle userHandle, boolean z) {
        String str2 = "ThemeOverlayManager";
        if (Build.DEBUG_ONEPLUS) {
            Log.d(str2, String.format("setEnabled: %s %s %b", new Object[]{str, userHandle, Boolean.valueOf(z)}));
        }
        if (str == null) {
