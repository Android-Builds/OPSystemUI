...
public class MLand extends FrameLayout {
    ...
    /* renamed from: dp */
    private static float f68dp = 1.0f;
    ...
    private class Cloud extends Scenery {
        public Cloud(Context context) {
            ...
            this.f79w = irand;
            this.f80z = 0.0f;
            this.f78v = MLand.frand(0.15f, 0.5f);
        }
    }
    ...
    private static class Params {
        ...
        public Params(Resources resources) {
            ...
            this.f72G = resources.getDimensionPixelSize(R$dimen.f59G);
            ...
            if (this.OBSTACLE_MIN <= this.OBSTACLE_WIDTH / 2) {
                MLand.m27L("error: obstacles might be too short, adjusting", new Object[0]);
    ...
    private static class Player extends ImageView implements GameView {
        ...
        public Player(Context context) {
            super(context);
            setBackgroundResource(R$drawable.f126android);
        ...
        public void step(long j, long j2, float f, float f2) {
            ...
            if (this.mBoosting) {
                this.f73dv = (float) (-MLand.PARAMS.BOOST_DV);
            } else {
                this.f73dv += (float) MLand.PARAMS.f72G;
            }
            if (this.f73dv < ((float) (-MLand.PARAMS.MAX_V))) {
                this.f73dv = (float) (-MLand.PARAMS.MAX_V);
            } else if (this.f73dv > ((float) MLand.PARAMS.MAX_V)) {
                this.f73dv = (float) MLand.PARAMS.MAX_V;
            }
            float translationY = getTranslationY() + (this.f73dv * f2);
            if (translationY < 0.0f) {
                translationY = 0.0f;
            }
            setTranslationY(translationY);
            setRotation(MLand.lerp(MLand.clamp(MLand.rlerp(this.f73dv, (float) MLand.PARAMS.MAX_V, (float) (MLand.PARAMS.MAX_V * -1))), 90.0f, -90.0f) + 90.0f);
    ...
    private class Pop extends Obstacle {
        ...
        public boolean intersects(Player player) {
            ...
            for (int i = 0; i < length; i++) {
                float[] fArr = player.corners;
                int i2 = i * 2;
                if (Math.hypot((double) (((int) fArr[i2]) - this.f74cx), (double) (((int) fArr[i2 + 1]) - this.f75cy)) <= ((double) this.f76r)) {
                    return true;
                }
            }
            return false;
        ...
        public void step(long j, long j2, float f, float f2) {
            ...
            this.f74cx = (rect.left + rect.right) / 2;
            this.f75cy = (rect.top + rect.bottom) / 2;
            this.f76r = getWidth() / 3;
        }
    ...
    private class Scenery extends FrameLayout implements GameView {
        ...
        /* renamed from: v */
        public float f78v = 0.0f;

        /* renamed from: w */
        public int f79w = MLand.irand(MLand.PARAMS.BUILDING_WIDTH_MIN, MLand.PARAMS.BUILDING_WIDTH_MAX);

        /* renamed from: z */
        public float f80z = 0.0f;
        ...
        public void step(long j, long j2, float f, float f2) {
            setTranslationX(getTranslationX() - ((MLand.PARAMS.TRANSLATION_PER_SEC * f2) * this.f78v));
        }
    }
    ...
    private class Stem extends Obstacle {
        ...
        public Stem(Context context, float f, boolean z) {
            super(context, f);
            this.f81id = MLand.this.mCurrentPipeId;
            this.mDrawShadow = z;
            setBackground(null);
    ...
    /* renamed from: L */
    public static void m27L(String str, Object... objArr) {
        if (DEBUG) {
            if (objArr.length != 0) {
    ...
    public MLand(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mPlayerTracePaint.setStrokeWidth(f68dp * 2.0f);
    ...
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        f68dp = getResources().getDisplayMetrics().density;
        reset();
        start(false);
    }
    ...
    private int addPlayerInternal(Player player) {
        ...
        realignPlayers();
        TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(R$layout.mland_scorefield, null);
    ...
    public void reset() {
        ...
        for (int i6 = 0; i6 < 20; i6++) {
            ...
            if (frand2 < 0.3d && this.mTimeOfDay != 0) {
                ...
                int i7 = this.mScene;
                scenery = i7 != 1 ? i7 != 2 ? new Building(getContext()) : new Mountain(getContext()) : new Cactus(getContext());
                scenery.f80z = ((float) i6) / 20.0f;
                scenery.f78v = scenery.f80z * 0.85f;
                if (this.mScene == 0) {
                    scenery.setBackgroundColor(-7829368);
                    scenery.f77h = irand(PARAMS.BUILDING_HEIGHT_MIN, i5);
                }
                int i8 = (int) (scenery.f80z * 255.0f);
            ...
            LayoutParams layoutParams = new LayoutParams(scenery.f79w, scenery.f77h);
            if (scenery instanceof Building) {
                ...
                if (scenery instanceof Star) {
                    ...
                    float f4 = frand3 * frand3;
                    int i9 = this.mHeight;
                    layoutParams.topMargin = ((int) (1.0f - ((f4 * ((float) i9)) / 2.0f))) + (i9 / 2);
                }
            }
    ...
    public void start(boolean z) {
        ...
        m27L("start(startPlaying=%s)", objArr);
    ...
    public void step(long j, long j2) {
        int i;
        this.f70t = ((float) j) / 1000.0f;
        this.f69dt = ((float) j2) / 1000.0f;
        if (DEBUG) {
            this.f70t *= 0.5f;
            this.f69dt *= 0.5f;
        }
        ...
        while (i < childCount) {
            ...
            if (childAt instanceof GameView) {
                ((GameView) childAt).step(j, j2, this.f70t, this.f69dt);
            }
            i2 = i + 1;
        }
        if (this.mPlaying) {
                ...
                if (player.mAlive) {
                    if (player.below(this.mHeight)) {
                        if (DEBUG_IDDQD) {
                            ...
                            m27L("player %d hit the floor", Integer.valueOf(i));
                            thump(i, 80);
                            player.die();
                        }
                    }
                    ...
                    while (true) {
                        ...
                        if (obstacle.intersects(player) && !DEBUG_IDDQD) {
                            m27L("player hit an obstacle", new Object[0]);
                            thump(i, 80);
                            player.die();
                        } else if (obstacle.cleared(player) && (obstacle instanceof Stem)) {
                            i4 = Math.max(i4, ((Stem) obstacle).f81id);
                        }
                        size = i5;
                    }
                    if (i4 > player.mScore) {
        ...
        while (true) {
            ...
            if (childAt2 instanceof Obstacle) {
                ...
                if (childAt2.getTranslationX() + ((float) ((Scenery) childAt2).f79w) < 0.0f) {
        ...
        if (this.mPlaying) {
            ...
            if (f - this.mLastPipeTime > ((float) PARAMS.OBSTACLE_PERIOD)) {
                ...
                addView(stem, new LayoutParams(PARAMS.OBSTACLE_STEM_WIDTH, (int) stem.f71h, 51));
                stem.setTranslationX((float) (this.mWidth + i12));
                float f2 = (float) i13;
                stem.setTranslationY((-stem.f71h) - f2);
                ...
                pop.setScaleX(0.25f);
                pop.setScaleY(-0.25f);
                pop.animate().translationY(stem.f71h - ((float) i12)).scaleX(1.0f).scaleY(-1.0f).setStartDelay(j3).setDuration(250);
                ...
                addView(stem2, new LayoutParams(PARAMS.OBSTACLE_STEM_WIDTH, (int) stem2.f71h, 51));
                ...
                long j4 = (long) irand2;
                stem2.animate().translationY(((float) this.mHeight) - stem2.f71h).setStartDelay(j4).setDuration(400);
                ...
                pop2.animate().translationY((((float) this.mHeight) - stem2.f71h) - f2).scaleX(1.0f).scaleY(1.0f).setStartDelay(j4).setDuration(400);
    ...
    public boolean onKeyDown(int i, KeyEvent keyEvent) {
        m27L("keyDown: %d", Integer.valueOf(i));
    ...
    private void unpoke(int i) {
        m27L("unboost(%d)", Integer.valueOf(i));
