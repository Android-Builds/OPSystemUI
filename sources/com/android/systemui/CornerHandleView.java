...
public class CornerHandleView extends View {
    ...
    private float getOuterRadiusPx() {
        int dimensionPixelSize = getResources().getDimensionPixelSize(R$dimen.rounded_corner_radius_bottom) / 2;
        if (dimensionPixelSize == 0) {
            dimensionPixelSize = getResources().getDimensionPixelSize(17105400);
        }
        if (dimensionPixelSize == 0) {
            dimensionPixelSize = getResources().getDimensionPixelSize(R$dimen.rounded_corner_radius_top) / 2;
        }
        if (dimensionPixelSize == 0) {
