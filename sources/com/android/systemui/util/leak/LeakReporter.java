    ...
    public void dumpLeak(int i) {
        ...
        try {
            ...
            try {
                ...
                notificationManager.notify(str2, 0, new Builder(this.mContext, notificationChannel.getId()).setAutoCancel(true).setShowWhen(true).setContentTitle("Memory Leak Detected").setContentText(String.format("SystemUI has detected %d leaked objects. Tap to send", new Object[]{Integer.valueOf(i)})).setSmallIcon(17303535).setContentIntent(PendingIntent.getActivityAsUser(this.mContext, 0, getIntent(file2, file3), 134217728, null, UserHandle.CURRENT)).build());
            } catch (Throwable th2) {
                Throwable th3 = th2;
                fileOutputStream.close();
                throw th3;
