...
public class QSContainerImpl extends FrameLayout {
    ...
    private void updateThemeColor() {
        this.mBackground.setBackgroundTintList(ColorStateList.valueOf(ThemeColorUtils.getColor(ThemeColorUtils.QS_PANEL_PRIMARY)));
    }
    ...
    private void updateResources() {
        ...
        layoutParams.topMargin = this.mContext.getResources().getDimensionPixelSize(17105392);
