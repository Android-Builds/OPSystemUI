...
public class UserDetailItemView extends LinearLayout {
    ...
    public void updateThemeColor(boolean z) {
        ...
        int color2 = ThemeColorUtils.getColor(ThemeColorUtils.QS_ACCENT);
    ...
    public void setActivated(boolean z) {
        ...
        if (z) {
            ...
            this.mAvatar.setFrameColor(ColorStateList.valueOf(this.mContext.getResources().getColor(R$color.transparent)));
        }
    }
