...
public class Divider extends SystemUI implements DividerCallbacks {
    ...
    class DockDividerVisibilityListener extends Stub {
        ...
        public void onAdjustedForImeChanged(boolean z, long j) throws RemoteException {
            Divider.this.mView.post(new Runnable(z, j) {
                ...
                public final void run() {
                    DockDividerVisibilityListener.this.mo14632x1fc4d65b(this.f$1, this.f$2);
                }
            });
        }

        /* renamed from: lambda$onAdjustedForImeChanged$0$Divider$DockDividerVisibilityListener */
        public /* synthetic */ void mo14632x1fc4d65b(boolean z, long j) {
        ...
        public void onDockSideChanged(int i) throws RemoteException {
            Divider.this.mView.post(new Runnable(i) {
                ...
                public final void run() {
                    DockDividerVisibilityListener.this.lambda$onDockSideChanged$1$Divider$DockDividerVisibilityListener(this.f$1);
                }
            });
        }
    }
    ...
    private void addDivider(Configuration configuration) {
        ...
        int dimensionPixelSize = this.mContext.getResources().getDimensionPixelSize(17105142);
    ...
    public void updateMinimizedDockedStack(boolean z, long j, boolean z2) {
        ...
        final boolean z4 = z;
        final long j2 = j;
        C11212 r1 = new Runnable() {
            public void run() {
                Divider.this.mHomeStackResizable = z3;
