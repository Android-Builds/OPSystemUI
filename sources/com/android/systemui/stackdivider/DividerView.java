...
public class DividerView extends FrameLayout implements OnTouchListener, OnComputeInternalInsetsListener {
        ...
        this.mHandler = new Handler() {
            public void handleMessage(Message message) {
                if (message.what != 0) {
                    ...
                    DividerView.this.resizeStack(message.arg1, message.arg2, (SnapTarget) message.obj);
                }
            }
        };
        this.mHandleDelegate = new AccessibilityDelegate() {
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                if (DividerView.this.isHorizontalDivision()) {
                    accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_move_tl_full, DividerView.this.mContext.getString(R$string.accessibility_action_divider_top_full)));
                    if (snapAlgorithm.isFirstSplitTargetAvailable()) {
                        accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_move_tl_70, DividerView.this.mContext.getString(R$string.accessibility_action_divider_top_70)));
                    }
                    if (snapAlgorithm.showMiddleSplitTargetForAccessibility()) {
                        accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_move_tl_50, DividerView.this.mContext.getString(R$string.accessibility_action_divider_top_50)));
                    }
                    if (snapAlgorithm.isLastSplitTargetAvailable()) {
                        accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_move_tl_30, DividerView.this.mContext.getString(R$string.accessibility_action_divider_top_30)));
                    }
                    accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_move_rb_full, DividerView.this.mContext.getString(R$string.accessibility_action_divider_bottom_full)));
                    return;
                }
                accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_move_tl_full, DividerView.this.mContext.getString(R$string.accessibility_action_divider_left_full)));
                if (snapAlgorithm.isFirstSplitTargetAvailable()) {
                    accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_move_tl_70, DividerView.this.mContext.getString(R$string.accessibility_action_divider_left_70)));
                }
                if (snapAlgorithm.showMiddleSplitTargetForAccessibility()) {
                    accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_move_tl_50, DividerView.this.mContext.getString(R$string.accessibility_action_divider_left_50)));
                }
                if (snapAlgorithm.isLastSplitTargetAvailable()) {
                    accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_move_tl_30, DividerView.this.mContext.getString(R$string.accessibility_action_divider_left_30)));
                }
                accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_move_rb_full, DividerView.this.mContext.getString(R$string.accessibility_action_divider_right_full)));
            }

            public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
                int currentPosition = DividerView.this.getCurrentPosition();
                SnapTarget snapTarget = i == R$id.action_move_tl_full ? DividerView.this.mSnapAlgorithm.getDismissEndTarget() : i == R$id.action_move_tl_70 ? DividerView.this.mSnapAlgorithm.getLastSplitTarget() : i == R$id.action_move_tl_50 ? DividerView.this.mSnapAlgorithm.getMiddleTarget() : i == R$id.action_move_tl_30 ? DividerView.this.mSnapAlgorithm.getFirstSplitTarget() : i == R$id.action_move_rb_full ? DividerView.this.mSnapAlgorithm.getDismissStartTarget() : null;
    ...
    public void onFinishInflate() {
        ...
        this.mDividerWindowWidth = getResources().getDimensionPixelSize(17105142);
        this.mDividerInsets = getResources().getDimensionPixelSize(17105141);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (i6 == 2) {
            ...
            i5 = i6 == 1 ? this.mBackground.getLeft() : i6 == 3 ? this.mBackground.getRight() - this.mMinimizedShadow.getWidth() : 0;
        }
    ...
    private void initializeSnapAlgorithm() {
        if (this.mSnapAlgorithm == null) {
            DividerSnapAlgorithm dividerSnapAlgorithm = new DividerSnapAlgorithm(getContext().getResources(), this.mDisplayWidth, this.mDisplayHeight, this.mDividerSize, isHorizontalDivision(), this.mStableInsets, this.mDockSide);
            this.mSnapAlgorithm = dividerSnapAlgorithm;
            SnapTarget snapTarget = this.mSnapTargetBeforeMinimized;
            if (snapTarget != null && snapTarget.isMiddleTarget) {
                this.mSnapTargetBeforeMinimized = this.mSnapAlgorithm.getMiddleTarget();
            }
        }
        if (this.mMinimizedSnapAlgorithm == null) {
            DividerSnapAlgorithm dividerSnapAlgorithm2 = new DividerSnapAlgorithm(getContext().getResources(), this.mDisplayWidth, this.mDisplayHeight, this.mDividerSize, isHorizontalDivision(), this.mStableInsets, this.mDockSide, this.mDockedStackMinimized && this.mHomeStackResizable);
            this.mMinimizedSnapAlgorithm = dividerSnapAlgorithm2;
        }
    }
    ...
    private ValueAnimator getFlingAnimator(int i, SnapTarget snapTarget, long j) {
        ...
        ofInt.addUpdateListener(new AnimatorUpdateListener(z, snapTarget) {
            ...
            private final /* synthetic */ SnapTarget f$2;
        ...
        final $$Lambda$DividerView$fuKXuLmLQTYwkdmcrCKfS4vkKk8 r7 = new Runnable(snapTarget) {
            private final /* synthetic */ SnapTarget f$1;
        ...
        final long j2 = j;
        C11294 r2 = new AnimatorListenerAdapter() {
        ...
        ofInt.addListener(r2);
        this.mCurrentAnimator = ofInt;
        return ofInt;
    }

    public /* synthetic */ void lambda$getFlingAnimator$0$DividerView(boolean z, SnapTarget snapTarget, ValueAnimator valueAnimator) {
        int i;
    ...
    public /* synthetic */ void lambda$getFlingAnimator$1$DividerView(SnapTarget snapTarget) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void commitSnapFlags(com.android.internal.policy.DividerSnapAlgorithm.SnapTarget r4) {
        /*
            r3 = this;
            int r4 = r4.flag
        ...
        L_0x001b:
            ...
            com.android.systemui.stackdivider.WindowManagerProxy r4 = r3.mWindowManagerProxy
            r4.dismissDockedStack()
            goto L_0x0028
        L_0x0023:
            com.android.systemui.stackdivider.WindowManagerProxy r4 = r3.mWindowManagerProxy
            r4.maximizeDockedStack()
        L_0x0028:
            com.android.systemui.stackdivider.WindowManagerProxy r3 = r3.mWindowManagerProxy
            r4 = 0
            r3.setResizeDimLayer(r0, r0, r4)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.stackdivider.DividerView.commitSnapFlags(com.android.internal.policy.DividerSnapAlgorithm$SnapTarget):void");
    }
    ...
    private void repositionSnapTargetBeforeMinimized() {
        int i = (int) (this.mState.mRatioPositionBeforeMinimized * ((float) (isHorizontalDivision() ? this.mDisplayHeight : this.mDisplayWidth)));
        this.mSnapAlgorithm = null;
        initializeSnapAlgorithm();
    ...
    private void resizeStack(SnapTarget snapTarget) {
        int i = snapTarget.position;
        resizeStack(i, i, snapTarget);
    }

    public void resizeStack(int i, int i2, SnapTarget snapTarget) {
        int i3 = i;
        int i4 = i2;
        SnapTarget snapTarget2 = snapTarget;
        if (!this.mRemoved) {
            ...
            if (!this.mDockedRect.equals(this.mLastResizeRect) || this.mEntranceAnimationRunning) {
                ...
                if (!this.mHomeStackResizable || !this.mIsInMinimizeInteraction) {
                    if (this.mEntranceAnimationRunning && i4 != Integer.MAX_VALUE) {
                        ...
                        SnapTarget snapTarget3 = snapTarget;
                        int i5 = i;
                    ...
                    SnapTarget closestDismissTarget = getSnapAlgorithm().getClosestDismissTarget(i3);
    ...
    private int getWindowingModeForDismissTarget(SnapTarget snapTarget) {
        return ((snapTarget.flag != 1 || !dockSideTopLeft(this.mDockSide)) && (snapTarget.flag != 2 || !dockSideBottomRight(this.mDockSide))) ? 4 : 3;
    }
    ...
    public void onUndockingTask() {
        ...
        if (this.mHomeStackResizable || !this.mDockedStackMinimized) {
            ...
            stopDragging(this.mExitStartPosition, snapTarget2, 336, 100, 0, Interpolators.FAST_OUT_SLOW_IN);
        }
    }
