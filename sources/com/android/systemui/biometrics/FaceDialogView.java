...
public class FaceDialogView extends BiometricDialogView {
    ...
    private final class DialogOutlineProvider extends ViewOutlineProvider {
        ...
        public void getOutline(View view, Outline outline) {
            outline.setRoundRect(0, (int) this.f65mY, FaceDialogView.this.mDialog.getWidth(), FaceDialogView.this.mDialog.getBottom(), FaceDialogView.this.getResources().getDimension(R$dimen.biometric_dialog_corner_size));
        }
    ...
    private final class IconController extends AnimationCallback {
    ...
    public FaceDialogView(Context context, DialogViewCallback dialogViewCallback, boolean z) {
    ...
    public int getAuthenticatedAccessibilityResourceId() {
        return this.mRequireConfirmation ? 17039989 : 17039990;
    }
    ...
    public void updateIcon(int i, int i2) {
        ...
        if (i2 == 1) {
            ...
            sb.append("Unknown animation from ");
            sb.append(i);
            sb.append(" -> ");
            sb.append(i2);
            Log.w("FaceDialogView", sb.toString());
        }
        if (i == 2 && i2 == 2) {
            this.mHandler.removeCallbacks(this.mErrorToIdleAnimationRunnable);
            this.mHandler.postDelayed(this.mErrorToIdleAnimationRunnable, 2000);
