    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (usbDevice == null) {
                ...
                alertParams.mMessage = getString(R$string.usb_device_permission_prompt, new Object[]{charSequence, usbDevice.getProductName()});
            ...
            if (booleanExtra && !(this.mDevice == null && this.mAccessory == null)) {
                alertParams.mView = ((LayoutInflater) getSystemService("layout_inflater")).inflate(17367090, null);
                ...
                if (usbDevice2 == null) {
                    ...
                    this.mAlwaysUse.setText(getString(R$string.always_use_device, new Object[]{charSequence, usbDevice2.getProductName()}));
                }
