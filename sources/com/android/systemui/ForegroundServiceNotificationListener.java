...
public class ForegroundServiceNotificationListener {
    ...
    public void updateNotification(StatusBarNotification statusBarNotification, int i) {
        this.mForegroundServiceController.updateUserState(statusBarNotification.getUserId(), new UserStateUpdateCallback(statusBarNotification, i) {
            ...
            public final boolean updateUserState(ForegroundServicesUserState foregroundServicesUserState) {
                return ForegroundServiceNotificationListener.this.mo11385xa2f2beea(this.f$1, this.f$2, foregroundServicesUserState);
            }
        }, true);
    }

    /* renamed from: lambda$updateNotification$0$ForegroundServiceNotificationListener */
    public /* synthetic */ boolean mo11385xa2f2beea(StatusBarNotification statusBarNotification, int i, ForegroundServicesUserState foregroundServicesUserState) {
