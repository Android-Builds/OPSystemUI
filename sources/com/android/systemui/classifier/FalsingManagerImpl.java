...
public class FalsingManagerImpl implements FalsingManager {
    ...
    public StateListener mStatusBarStateListener = new StateListener() {
        public void onStateChanged(int i) {
            if (FalsingLog.ENABLED) {
                ...
                FalsingLog.m26i("setStatusBarState", sb.toString());
            }
        ...
        if (z || !shouldSessionBeActive()) {
            ...
            if (this.mIsFalseTouchCalls != 0) {
                if (FalsingLog.ENABLED) {
                    ...
                    FalsingLog.m26i("isFalseTouchCalls", sb.toString());
                }
    ...
    private void onSessionStart() {
        if (FalsingLog.ENABLED) {
            ...
            sb.append(isClassiferEnabled());
            FalsingLog.m26i("onSessionStart", sb.toString());
            clearPendingWtf();
        }
    ...
    public boolean isFalseTouch() {
        ...
        if (!isFalseTouch) {
            if (FalsingLog.ENABLED) {
                ...
                FalsingLog.m26i("isFalseTouchCalls", sb2.toString());
            }
    ...
    public void onScreenTurningOn() {
        if (FalsingLog.ENABLED) {
            ...
            sb.append("from=");
            sb.append(this.mScreenOn ? 1 : 0);
            FalsingLog.m26i("onScreenTurningOn", sb.toString());
            clearPendingWtf();
        }
        this.mScreenOn = true;
    ...
    public void onScreenOnFromTouch() {
        if (FalsingLog.ENABLED) {
            ...
            sb.append("from=");
            sb.append(this.mScreenOn ? 1 : 0);
            FalsingLog.m26i("onScreenOnFromTouch", sb.toString());
        }
        this.mScreenOn = true;
        if (sessionEntrypoint()) {
    ...
    public void onScreenOff() {
        if (FalsingLog.ENABLED) {
            ...
            sb.append("from=");
            sb.append(this.mScreenOn ? 1 : 0);
            FalsingLog.m26i("onScreenOff", sb.toString());
        }
    ...
    public void onSucccessfulUnlock() {
        if (FalsingLog.ENABLED) {
            FalsingLog.m26i("onSucccessfulUnlock", "");
        }
    ...
    public void onBouncerShown() {
        if (FalsingLog.ENABLED) {
            ...
            FalsingLog.m26i("onBouncerShown", sb.toString());
        }
        if (!this.mBouncerOn) {
    ...
    public void onBouncerHidden() {
        if (FalsingLog.ENABLED) {
            ...
            sb.append("from=");
            sb.append(this.mBouncerOn ? 1 : 0);
            FalsingLog.m26i("onBouncerHidden", sb.toString());
        }
        if (this.mBouncerOn) {
            this.mBouncerOn = false;
    ...
    public void onTrackingStarted(boolean z) {
        if (FalsingLog.ENABLED) {
            FalsingLog.m26i("onTrackingStarted", "");
        }
    ...
    public void onNotificationDoubleTap(boolean z, float f, float f2) {
        if (FalsingLog.ENABLED) {
            ...
            sb.append(f2);
            sb.append(" (px)");
            FalsingLog.m26i("onNotificationDoubleTap", sb.toString());
        }
    ...
    public void onNotificatonStartDraggingDown() {
        if (FalsingLog.ENABLED) {
            FalsingLog.m26i("onNotificatonStartDraggingDown", "");
        }
    ...
    public void onStartExpandingFromPulse() {
        if (FalsingLog.ENABLED) {
            FalsingLog.m26i("onStartExpandingFromPulse", "");
        }
    ...
    public void onNotificatonStartDismissing() {
        if (FalsingLog.ENABLED) {
            FalsingLog.m26i("onNotificatonStartDismissing", "");
        }
    ...
    public void onAffordanceSwipingStarted(boolean z) {
        if (FalsingLog.ENABLED) {
            FalsingLog.m26i("onAffordanceSwipingStarted", "");
        }
        if (z) {
