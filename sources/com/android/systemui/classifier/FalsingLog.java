...
public class FalsingLog {
    ...
    /* renamed from: i */
    public static void m26i(String str, String str2) {
        if (LOGCAT) {
    ...
    /* renamed from: e */
    public static void m25e(String str, String str2) {
        if (LOGCAT) {
            StringBuilder sb = new StringBuilder();
            sb.append(str);
            sb.append("\t");
    ...
    /* JADX WARNING: Removed duplicated region for block: B:33:0x0086 A[Catch:{ all -> 0x0083 }] */
    ...
    public static synchronized void wtf(java.lang.String r7, java.lang.String r8, java.lang.Throwable r9) {
        ...
        L_0x0009:
            ...
            r1 = 0
            java.io.PrintWriter r4 = new java.io.PrintWriter     // Catch:{ IOException -> 0x0073, all -> 0x0070 }
            r4.<init>(r3)     // Catch:{ IOException -> 0x0073, all -> 0x0070 }
        ...
        L_0x0076:
            ...
            android.util.Log.e(r3, r5, r1)     // Catch:{ all -> 0x0083 }
