...
public class ZenModePanel extends FrameLayout {
    ...
    /* access modifiers changed from: private */
    public final C1723H mHandler = new C1723H();
    ...
    private final class C1723H extends Handler {
        private C1723H() {
    ...
    private String computeAlarmWarningText(boolean z) {
        ...
        return getResources().getString(i, new Object[]{getResources().getString(z2 ? R$string.alarm_template : R$string.alarm_template_far, new Object[]{DateFormat.format(DateFormat.getBestDateTimePattern(Locale.getDefault(), str), nextAlarm)})});
    }
    ...
    private void bind(Condition condition, View view, int i) {
        ...
        if (condition2 != null) {
            ...
            boolean z3 = conditionTag.f106rb == null;
            if (conditionTag.f106rb == null) {
                conditionTag.f106rb = (RadioButton) this.mZenRadioGroup.getChildAt(i2);
            }
            ...
            conditionTag.f106rb.setEnabled(z2);
            conditionTag.f106rb.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    if (ZenModePanel.this.mExpanded && z) {
                        conditionTag.f106rb.setChecked(true);
                        if (ZenModePanel.DEBUG) {
                            String access$800 = ZenModePanel.this.mTag;
                            StringBuilder sb = new StringBuilder();
            ...
            conditionTag.lines.setOnClickListener(new OnClickListener() {
                public void onClick(View view) {
                    conditionTag.f106rb.setChecked(true);
                }
            });
            ...
            if (z3) {
                Interaction.register(conditionTag.f106rb, this.mInteractionCallback);
    ...
    public void onClickTimeButton(View view, ConditionTag conditionTag, boolean z, int i) {
        ...
        conditionTag2.f106rb.setChecked(true);
        select(condition2);
