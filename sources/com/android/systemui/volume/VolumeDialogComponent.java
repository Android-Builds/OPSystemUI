...
import com.oneplus.opthreekey.OpThreekeyDialog;
...
public class VolumeDialogComponent implements VolumeComponent, Tunable, UserActivityListener, OpThreekeyDialog.UserActivityListener {
    ...
    public VolumeDialogComponent(SystemUI systemUI, Context context) {
        ...
        ExtensionBuilder newExtension = ((ExtensionController) Dependency.get(ExtensionController.class)).newExtension(VolumeDialog.class);
    ...
    public /* synthetic */ void lambda$new$0$VolumeDialogComponent(VolumeDialog volumeDialog) {
        ...
        if (OpUtils.isSupportSOCThreekey()) {
            ...
            this.mThreekeyDialog = new OpThreekeyDialogImpl(this.mContext);
            this.mThreekeyDialog.init(2020, this);
        }
    }
