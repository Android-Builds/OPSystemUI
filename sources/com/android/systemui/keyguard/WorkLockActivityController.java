...
public class WorkLockActivityController {
    ...
    private int startActivityAsUser(Intent intent, Bundle bundle, int i) {
        try {
            ...
            return this.mIatm.startActivityAsUser(this.mContext.getIApplicationThread(), this.mContext.getBasePackageName(), intent, intent.resolveTypeIfNeeded(this.mContext.getContentResolver()), null, null, 0, 268435456, null, bundle, i);
