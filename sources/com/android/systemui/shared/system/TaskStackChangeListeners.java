...
public class TaskStackChangeListeners extends TaskStackListener {
    ...
    private final class C1115H extends Handler {
        public C1115H(Looper looper) {
            super(looper);
        }
            ...
            synchronized (TaskStackChangeListeners.this.mTaskStackListeners) {
                switch (message.what) {
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        RunningTaskInfo runningTaskInfo = (RunningTaskInfo) message.obj;
                    ...
                    case 18:
                        for (int size18 = TaskStackChangeListeners.this.mTaskStackListeners.size() - 1; size18 >= 0; size18--) {
                            ((TaskStackChangeListener) TaskStackChangeListeners.this.mTaskStackListeners.get(size18)).onBackPressedOnTaskRoot((RunningTaskInfo) message.obj);
                        }
                        break;
                    case 19:
    ...
    public TaskStackChangeListeners(Looper looper) {
        this.mHandler = new C1115H(looper);
    }
