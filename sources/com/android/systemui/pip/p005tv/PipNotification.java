...
public class PipNotification {
    ...
    public PipNotification(Context context) {
        ...
        this.mNotificationBuilder = new Builder(context, NotificationChannels.TVPIP).setLocalOnly(true).setOngoing(false).setCategory("sys").extend(new TvExtender().setContentIntent(createPendingIntent(context, str)).setDeleteIntent(createPendingIntent(context, str2)));
