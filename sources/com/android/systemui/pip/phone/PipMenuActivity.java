...
public class PipMenuActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.mMenuContainer.setOnTouchListener(new OnTouchListener() {
            ...
            if (this.mMenuState != 1) {
                ...
                if (this.mActionsGroup != null) {
                    ...
                    while (i2 < this.mActions.size()) {
                        ...
                        remoteAction.getIcon().loadDrawableAsync(this, new OnDrawableLoadedListener(imageView) {
                        ...
                        if (remoteAction.isEnabled()) {
                            imageView.setOnClickListener(new OnClickListener(remoteAction) {
                        ...
                        ((LayoutParams) imageView.getLayoutParams()).leftMargin = (!z || i2 <= 0) ? 0 : this.mBetweenActionPaddingLand;
                        i2++;
                    }
                }
    ...
    private void notifyRegisterInputConsumer() {
        ...
        obtain.what = C0526R.styleable.AppCompatTheme_textAppearanceListItemSmall;
        sendMessage(obtain, "Could not notify controller to register input consumer");
    }

    private void notifyUnregisterInputConsumer() {
        Message obtain = Message.obtain();
        obtain.what = C0526R.styleable.AppCompatTheme_textAppearancePopupMenuHeader;
    ...
    public /* synthetic */ void lambda$expandPip$7$PipMenuActivity() {
        sendEmptyMessage(C0526R.styleable.AppCompatTheme_switchStyle, "Could not notify controller to expand PIP");
    }
    ...
    public /* synthetic */ void lambda$dismissPip$8$PipMenuActivity() {
        sendEmptyMessage(C0526R.styleable.AppCompatTheme_textAppearanceListItem, "Could not notify controller to dismiss PIP");
    }

    private void showPipMenu() {
        Message obtain = Message.obtain();
        obtain.what = C0526R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle;
        sendMessage(obtain, "Could not notify controller to show PIP menu");
    }

    private void showSettings() {
        Pair topPinnedActivity = PipUtils.getTopPinnedActivity(this, ActivityManager.getService());
        if (topPinnedActivity.first != null) {
            ...
            Intent intent = new Intent(str, Uri.fromParts("package", ((ComponentName) topPinnedActivity.first).getPackageName(), null));
    ...
    private void notifyActivityCallback(Messenger messenger) {
        Message obtain = Message.obtain();
        obtain.what = C0526R.styleable.AppCompatTheme_textAppearanceListItemSecondary;
