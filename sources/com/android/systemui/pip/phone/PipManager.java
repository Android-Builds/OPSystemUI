...
public class PipManager implements BasePipManager {
        ...
        public void onActivityUnpinned() {
            ...
            ((UiOffloadThread) Dependency.get(UiOffloadThread.class)).submit(new Runnable(componentName) {
                ...
                public final void run() {
                    C09241.lambda$onActivityUnpinned$1(this.f$0);
                }
            });
        }
    ...
    private class PinnedStackListener extends Stub {
        ...
        public void onListenerRegistered(IPinnedStackController iPinnedStackController) {
            PipManager.this.mHandler.post(new Runnable(iPinnedStackController) {
                ...
                public final void run() {
                    PinnedStackListener.this.lambda$onListenerRegistered$0$PipManager$PinnedStackListener(this.f$1);
                }
            });
        }
        ...
        public void onImeVisibilityChanged(boolean z, int i) {
            PipManager.this.mHandler.post(new Runnable(z, i) {
                ...
                public final void run() {
                    PinnedStackListener.this.lambda$onImeVisibilityChanged$1$PipManager$PinnedStackListener(this.f$1, this.f$2);
                }
            });
        }
        ...
        public void onShelfVisibilityChanged(boolean z, int i) {
            PipManager.this.mHandler.post(new Runnable(z, i) {
                ...
                public final void run() {
                    PinnedStackListener.this.lambda$onShelfVisibilityChanged$2$PipManager$PinnedStackListener(this.f$1, this.f$2);
                }
            });
        }
        ...
        public void onMinimizedStateChanged(boolean z) {
            PipManager.this.mHandler.post(new Runnable(z) {
                ...
                public final void run() {
                    PinnedStackListener.this.lambda$onMinimizedStateChanged$3$PipManager$PinnedStackListener(this.f$1);
                }
            });
        }
        ...
        public void onMovementBoundsChanged(Rect rect, Rect rect2, Rect rect3, boolean z, boolean z2, int i) {
            ...
            C0917xb42d95c5 r0 = new Runnable(rect, rect2, rect3, z, z2, i) {
                ...
                public final void run() {
                    PinnedStackListener.this.lambda$onMovementBoundsChanged$4$PipManager$PinnedStackListener(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6);
                }
            };
            access$700.post(r0);
        }
        ...
        public void onActionsChanged(ParceledListSlice parceledListSlice) {
            PipManager.this.mHandler.post(new Runnable(parceledListSlice) {
                ...
                public final void run() {
                    PinnedStackListener.this.lambda$onActionsChanged$5$PipManager$PinnedStackListener(this.f$1);
                }
            });
        }
    ...
    public void initialize(Context context) {
        ...
        PipTouchHandler pipTouchHandler = new PipTouchHandler(context, this.mActivityManager, this.mActivityTaskManager, this.mMenuController, this.mInputConsumerController);
