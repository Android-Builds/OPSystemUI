        ...
        public void handleMessage(Message message) {
            switch (message.what) {
                ...
                case C0526R.styleable.AppCompatTheme_switchStyle /*101*/:
                    PipMenuActivityController.this.mListeners.forEach(C0918xe1b000b3.INSTANCE);
                    return;
                case C0526R.styleable.AppCompatTheme_textAppearanceLargePopupMenu /*102*/:
                    PipMenuActivityController.this.mListeners.forEach(C0920x72ebda8b.INSTANCE);
                    return;
                case C0526R.styleable.AppCompatTheme_textAppearanceListItem /*103*/:
                    PipMenuActivityController.this.mListeners.forEach(C0921xb9b5077f.INSTANCE);
                    return;
                case C0526R.styleable.AppCompatTheme_textAppearanceListItemSecondary /*104*/:
                    ...
                    return;
                case C0526R.styleable.AppCompatTheme_textAppearanceListItemSmall /*105*/:
                    PipMenuActivityController.this.mInputConsumerController.registerInputConsumer();
                    return;
                case C0526R.styleable.AppCompatTheme_textAppearancePopupMenuHeader /*106*/:
                    PipMenuActivityController.this.mInputConsumerController.unregisterInputConsumer();
                    return;
                case C0526R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle /*107*/:
                    PipMenuActivityController.this.mListeners.forEach(C0919xaff7c112.INSTANCE);
                    return;
                default:
                    return;
            }
