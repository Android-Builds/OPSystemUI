...
public abstract class GlobalActionsLayout extends MultiListLayout {
    ...
    private void setBackgrounds() {
        int color = getResources().getColor(R$color.global_actions_grid_background, null);
        int color2 = getResources().getColor(R$color.global_actions_separated_background, null);
