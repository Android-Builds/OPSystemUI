...
public class HardwareUiLayout extends MultiListLayout implements Tunable {
    ...
    private void updateSettings() {
        int i = 0;
        this.mEdgeBleed = Secure.getInt(getContext().getContentResolver(), "sysui_hwui_edge_bleed", 0) != 0;
        this.mRoundedDivider = Secure.getInt(getContext().getContentResolver(), "sysui_hwui_rounded_divider", 0) != 0;
        if (!this.mEdgeBleed) {
            i = getEdgePadding();
        }
        updateEdgeMargin(i);
    ...
    private void updateEdgeMargin(int i) {
        ...
        if (viewGroup2 != null) {
            MarginLayoutParams marginLayoutParams2 = (MarginLayoutParams) viewGroup2.getLayoutParams();
    ...
    private void rotateRight() {
        ...
        LayoutParams layoutParams2 = (LayoutParams) this.mSeparatedView.getLayoutParams();
    ...
    public void lambda$onMeasure$0$HardwareUiLayout() {
        ...
        int i5;
        boolean hasSeparatedItems = this.mAdapter.hasSeparatedItems();
        MarginLayoutParams marginLayoutParams = (MarginLayoutParams) this.mSeparatedView.getLayoutParams();
        int rotation = RotationUtils.getRotation(getContext());
        if (rotation == 1) {
            i3 = getPaddingLeft();
    ...
    public /* synthetic */ void lambda$new$5$HardwareUiLayout(InternalInsetsInfo internalInsetsInfo) {
