...
public final class DumpController implements Dumpable {
    ...
    public final void addListener(Dumpable dumpable) {
        ...
        synchronized (this.listeners) {
            ...
            if (!(list instanceof Collection) || !list.isEmpty()) {
                ...
                while (true) {
                    if (it.hasNext()) {
                        if (Intrinsics.areEqual((Dumpable) ((WeakReference) it.next()).get(), dumpable)) {
                            z = true;
                            break;
                        }
                    } else {
    ...
    public final void removeListener(Dumpable dumpable) {
        Intrinsics.checkParameterIsNotNull(dumpable, "listener");
        synchronized (this.listeners) {
            CollectionsKt__MutableCollectionsKt.removeAll(this.listeners, new DumpController$removeListener$$inlined$synchronized$lambda$1(this, dumpable));
        }
    }
