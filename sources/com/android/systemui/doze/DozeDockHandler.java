...
public class DozeDockHandler implements Part {
    ...
    static /* synthetic */ class C08401 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.doze.DozeDockHandler.C08401.<clinit>():void");
        }
    }
    ...
    private class DockEventListener implements com.android.systemui.dock.DockManager.DockEventListener {
        ...
        /* synthetic */ DockEventListener(DozeDockHandler dozeDockHandler, C08401 r2) {
            this();
        }
    ...
    public void transitionTo(State state, State state2) {
        int i = C08401.$SwitchMap$com$android$systemui$doze$DozeMachine$State[state2.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i == 4) {
    ...
    public void lambda$transitionTo$0$DozeDockHandler(State state) {
