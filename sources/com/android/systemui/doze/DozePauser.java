...
public class DozePauser implements Part {
    ...
    static /* synthetic */ class C08441 {
        ...
        static {
            try {
                $SwitchMap$com$android$systemui$doze$DozeMachine$State[State.DOZE_AOD_PAUSING.ordinal()] = 1;
    ...
    public void transitionTo(State state, State state2) {
        if (C08441.$SwitchMap$com$android$systemui$doze$DozeMachine$State[state2.ordinal()] != 1) {
