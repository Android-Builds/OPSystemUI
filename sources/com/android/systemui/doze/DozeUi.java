...
public class DozeUi implements Part {
    ...
    static /* synthetic */ class C08533 {
        ...
        static {
            ...
            L_0x007a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.doze.DozeUi.C08533.<clinit>():void");
        }
    }
    ...
    public void transitionTo(State state, State state2) {
        switch (C08533.$SwitchMap$com$android$systemui$doze$DozeMachine$State[state2.ordinal()]) {
            case 1:
                if (state == State.DOZE_AOD_PAUSED) {
    ...
    private void updateAnimateWakeup(State state) {
        boolean z = true;
        switch (C08533.$SwitchMap$com$android$systemui$doze$DozeMachine$State[state.ordinal()]) {
            case 5:
            case 8:
            case 9:
            case 10:
