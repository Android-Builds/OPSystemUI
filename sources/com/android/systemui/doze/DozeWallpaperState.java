...
public class DozeWallpaperState implements Part {
    ...
    static /* synthetic */ class C08541 {
        ...
        static {
            ...
            L_0x0062:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.doze.DozeWallpaperState.C08541.<clinit>():void");
        }
    }

    public DozeWallpaperState(Context context, BiometricUnlockController biometricUnlockController) {
        this(Stub.asInterface(ServiceManager.getService("wallpaper")), biometricUnlockController, DozeParameters.getInstance(context));
    }
    ...
    public void transitionTo(State state, State state2) {
        ...
        switch (C08541.$SwitchMap$com$android$systemui$doze$DozeMachine$State[state2.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
