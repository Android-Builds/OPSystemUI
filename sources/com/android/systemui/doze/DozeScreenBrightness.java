...
public class DozeScreenBrightness extends BroadcastReceiver implements Part, SensorEventListener {
    ...
    static /* synthetic */ class C08451 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.doze.DozeScreenBrightness.C08451.<clinit>():void");
        }
    }
    ...
    @VisibleForTesting
    public DozeScreenBrightness(Context context, Service service, SensorManager sensorManager, Sensor sensor, DozeHost dozeHost, Handler handler, int i, int[] iArr, int[] iArr2, boolean z) {
        this.mPaused = false;
    ...
    public DozeScreenBrightness(Context context, Service service, SensorManager sensorManager, Sensor sensor, DozeHost dozeHost, Handler handler, AlwaysOnDisplayPolicy alwaysOnDisplayPolicy) {
        AlwaysOnDisplayPolicy alwaysOnDisplayPolicy2 = alwaysOnDisplayPolicy;
        this(context, service, sensorManager, sensor, dozeHost, handler, context.getResources().getInteger(17694893), alwaysOnDisplayPolicy2.screenBrightnessArray, alwaysOnDisplayPolicy2.dimmingScrimArray, DEBUG_AOD_BRIGHTNESS);
    }

    public void transitionTo(State state, State state2) {
        int i = C08451.$SwitchMap$com$android$systemui$doze$DozeMachine$State[state2.ordinal()];
        boolean z = false;
        if (i == 1) {
