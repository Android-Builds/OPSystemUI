...
public class SlicePermissionActivity extends Activity implements OnClickListener, OnDismissListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            AlertDialog create = new Builder(this).setTitle(getString(R$string.slice_permission_title, new Object[]{unicodeWrap, unicodeWrap2})).setView(R$layout.slice_permission_request).setNegativeButton(R$string.slice_permission_deny, this).setPositiveButton(R$string.slice_permission_allow, this).setOnDismissListener(this).create();
