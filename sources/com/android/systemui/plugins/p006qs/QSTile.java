    ...
    public static class State {
        ...
        public boolean copyTo(State state2) {
            if (state2 == null) {
                ...
                state2.lottiePrefix = this.lottiePrefix;
                state2.lottieSupport = this.lottieSupport;
                return z;
            } else {
                throw new IllegalArgumentException();
            }
