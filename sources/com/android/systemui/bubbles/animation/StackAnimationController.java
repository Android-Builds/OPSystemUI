...
public class StackAnimationController extends PhysicsAnimationController {
    ...
    public float flingStackThenSpringToEdge(float f, float f2, float f3) {
        ...
        springForce.setStiffness(750.0f);
        springForce.setDampingRatio(0.85f);
        flingThenSpringFirstBubbleWithStackFollowing(viewProperty, f9, 2.2f, springForce, Float.valueOf(f7));
        ViewProperty viewProperty2 = DynamicAnimation.TRANSLATION_Y;
        SpringForce springForce2 = new SpringForce();
        springForce2.setStiffness(750.0f);
        springForce2.setDampingRatio(0.85f);
    ...
    public void flingThenSpringFirstBubbleWithStackFollowing(ViewProperty viewProperty, float f, float f2, SpringForce springForce, Float f3) {
        ...
        $$Lambda$StackAnimationController$RhB8HpuZAhRpI0Km19AlqvKSuI r0 = new OnAnimationEndListener(viewProperty, springForce, f3, f6, f7) {
            ...
            public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
                StackAnimationController.this.mo12239xc7358b8d(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, dynamicAnimation, z, f, f2);
            }
        };
    ...
    /* renamed from: lambda$flingThenSpringFirstBubbleWithStackFollowing$1$StackAnimationController */
    public /* synthetic */ void mo12239xc7358b8d(ViewProperty viewProperty, SpringForce springForce, Float f, float f2, float f3, DynamicAnimation dynamicAnimation, boolean z, float f4, float f5) {
        float f6;
        if (!z) {
            if (f != null) {
                f6 = f.floatValue();
    ...
    /* access modifiers changed from: protected */
    public void springFirstBubbleWithStackFollowing(ViewProperty viewProperty, SpringForce springForce, float f, float f2) {
