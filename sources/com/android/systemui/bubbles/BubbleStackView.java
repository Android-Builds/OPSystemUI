...
public class BubbleStackView extends FrameLayout {
    ...
    public BubbleStackView(Context context, BubbleData bubbleData, SurfaceSynchronizer surfaceSynchronizer) {
        ...
        this.mDismissContainer.setLayoutParams(new LayoutParams(-1, getResources().getDimensionPixelSize(R$dimen.pip_dismiss_gradient_height), 80));
        ...
        this.mMoveStackToValidPositionOnLayoutListener = new OnLayoutChangeListener() {
        ...
        this.mDesaturateAndDarkenAnimator.addUpdateListener(new AnimatorUpdateListener(colorMatrix, colorMatrix2) {
    ...
    public void onInitializeAccessibilityNodeInfoInternal(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_move_top_left, getContext().getResources().getString(R$string.bubble_accessibility_action_move_top_left)));
        accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_move_top_right, getContext().getResources().getString(R$string.bubble_accessibility_action_move_top_right)));
        accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_move_bottom_left, getContext().getResources().getString(R$string.bubble_accessibility_action_move_bottom_left)));
        accessibilityNodeInfo.addAction(new AccessibilityAction(R$id.action_move_bottom_right, getContext().getResources().getString(R$string.bubble_accessibility_action_move_bottom_right)));
    ...
    public void addBubble(Bubble bubble) {
        ...
        this.mBubbleContainer.addView(bubble.iconView, 0, new LayoutParams(-2, -2));
    ...
    public void removeBubble(Bubble bubble) {
        ...
        if (indexOfChild >= 0) {
            ...
            sb.append(bubble);
            Log.d("BubbleStackView", sb.toString());
        }
        updatePointerPosition();
    }
    ...
    public void updateBubbleOrder(List<Bubble> list) {
        for (int i = 0; i < list.size(); i++) {
            this.mBubbleContainer.reorderView(((Bubble) list.get(i)).iconView, i);
        }
    }
    ...
    /* JADX WARNING: type inference failed for: r4v2, types: [com.android.systemui.bubbles.BubbleFlyoutView] */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public android.view.View getTargetView(android.view.MotionEvent r5) {
        /*
            r4 = this;
            float r0 = r5.getRawX()
            float r5 = r5.getRawY()
            boolean r1 = r4.mIsExpanded
            if (r1 == 0) goto L_0x003c
            com.android.systemui.bubbles.animation.PhysicsAnimationLayout r1 = r4.mBubbleContainer
            boolean r1 = r4.isIntersecting(r1, r0, r5)
            if (r1 == 0) goto L_0x002f
            r1 = 0
        L_0x0015:
            com.android.systemui.bubbles.animation.PhysicsAnimationLayout r2 = r4.mBubbleContainer
            int r2 = r2.getChildCount()
            if (r1 >= r2) goto L_0x003a
            com.android.systemui.bubbles.animation.PhysicsAnimationLayout r2 = r4.mBubbleContainer
            android.view.View r2 = r2.getChildAt(r1)
            com.android.systemui.bubbles.BubbleView r2 = (com.android.systemui.bubbles.BubbleView) r2
            boolean r3 = r4.isIntersecting(r2, r0, r5)
        ...
        L_0x002c:
            ...
            goto L_0x0015
        L_0x002f:
            android.widget.FrameLayout r1 = r4.mExpandedViewContainer
            boolean r5 = r4.isIntersecting(r1, r0, r5)
            if (r5 == 0) goto L_0x003a
            android.widget.FrameLayout r4 = r4.mExpandedViewContainer
            return r4
        L_0x003a:
            r4 = 0
            return r4
        L_0x003c:
            com.android.systemui.bubbles.BubbleFlyoutView r1 = r4.mFlyout
            int r1 = r1.getVisibility()
            if (r1 != 0) goto L_0x004e
            com.android.systemui.bubbles.BubbleFlyoutView r1 = r4.mFlyout
            boolean r5 = r4.isIntersecting(r1, r0, r5)
            if (r5 == 0) goto L_0x004e
            com.android.systemui.bubbles.BubbleFlyoutView r4 = r4.mFlyout
        L_0x004e:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.bubbles.BubbleStackView.getTargetView(android.view.MotionEvent):android.view.View");
    }
    ...
    public void magnetToStackIfNeededThenAnimateDismissal(View view, float f, float f2, Runnable runnable) {
        $$Lambda$BubbleStackView$wNBb9TcVorXyGaagZMMDs0nXEJw r1 = new Runnable(view, runnable, this.mExpandedAnimationController.getDraggedOutBubble()) {
            ...
            public final void run() {
                BubbleStackView.this.mo12080x3f995e1b(this.f$1, this.f$2, this.f$3);
            }
        };
    ...
    public /* synthetic */ void mo12080x3f995e1b(View view, Runnable runnable, View view2) {
        ...
        if (view == this) {
            this.mStackAnimationController.implodeStack(new Runnable(runnable) {
                ...
                public final void run() {
                    BubbleStackView.this.mo12078x9e45a219(this.f$1);
                }
            });
        } else {
            this.mExpandedAnimationController.dismissDraggedOutBubble(view2, new Runnable(runnable) {
                ...
                public final void run() {
                    BubbleStackView.this.mo12079xeeef801a(this.f$1);
                }
            });
        }
    }
    ...
    public /* synthetic */ void mo12078x9e45a219(Runnable runnable) {
        this.mAnimatingMagnet = false;
    ...
    public /* synthetic */ void mo12079xeeef801a(Runnable runnable) {
        this.mAnimatingMagnet = false;
        this.mShowingDismiss = false;
        this.mDraggingInDismissTarget = false;
        resetDesaturationAndDarken();
    ...
    private void logBubbleEvent(Bubble bubble, int i) {
        ...
        if (bubble2 != null) {
            NotificationEntry notificationEntry = bubble2.entry;
            if (notificationEntry != null) {
                StatusBarNotification statusBarNotification = notificationEntry.notification;
                if (statusBarNotification != null) {
                    StatsLog.write(149, statusBarNotification.getPackageName(), statusBarNotification.getNotification().getChannelId(), statusBarNotification.getId(), getBubbleIndex(bubble), getBubbleCount(), i, getNormalizedXPosition(), getNormalizedYPosition(), bubble2.entry.showInShadeWhenBubble(), bubble2.entry.isForegroundService(), BubbleController.isForegroundApp(this.mContext, statusBarNotification.getPackageName()));
                    return;
                }
            }
        }
