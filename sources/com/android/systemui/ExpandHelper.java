...
import com.oneplus.systemui.OpExpandHelper;

public class ExpandHelper extends OpExpandHelper implements Gefingerpoken {
    ...
    public ExpandHelper(Context context, Callback callback, int i, int i2) {
        ...
        setQuickScaleEnabledInternal(this.mSGD, false);
