...
public class Lifecycle extends LifecycleRegistry {
    ...
    static /* synthetic */ class C06861 {
        ...
        static {
            ...
            L_0x0056:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settingslib.core.lifecycle.Lifecycle.C06861.<clinit>():void");
        }
    }
    ...
    private class LifecycleProxy implements LifecycleObserver {
        ...
        public void onLifecycleEvent(LifecycleOwner lifecycleOwner, Event event) {
            switch (C06861.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()]) {
                case 2:
                    this.this$0.onStart();
                    return;
                case 3:
