...
public class MediaSessions {
    ...
    private final class C0698H extends Handler {
        private C0698H(Looper looper) {
            super(looper);
        }
    ...
    private final class MediaControllerRecord extends Callback {
        ...
        /* renamed from: cb */
        private String m7cb(String str) {
        ...
        public void onAudioInfoChanged(PlaybackInfo playbackInfo) {
            if (C0695D.BUG) {
                ...
                StringBuilder sb = new StringBuilder();
                sb.append(m7cb("onAudioInfoChanged"));
        ...
        public void onExtrasChanged(Bundle bundle) {
            if (C0695D.BUG) {
                String access$200 = MediaSessions.TAG;
                StringBuilder sb = new StringBuilder();
                sb.append(m7cb("onExtrasChanged"));
                sb.append(bundle);
                Log.d(access$200, sb.toString());
            }
        }
        ...
        public void onMetadataChanged(MediaMetadata mediaMetadata) {
            if (C0695D.BUG) {
                String access$200 = MediaSessions.TAG;
                StringBuilder sb = new StringBuilder();
                sb.append(m7cb("onMetadataChanged"));
        ...
        public void onPlaybackStateChanged(PlaybackState playbackState) {
            if (C0695D.BUG) {
                String access$200 = MediaSessions.TAG;
                StringBuilder sb = new StringBuilder();
                sb.append(m7cb("onPlaybackStateChanged"));
        ...
        public void onQueueTitleChanged(CharSequence charSequence) {
            if (C0695D.BUG) {
                String access$200 = MediaSessions.TAG;
                StringBuilder sb = new StringBuilder();
                sb.append(m7cb("onQueueTitleChanged"));
        ...
        public void onSessionDestroyed() {
            if (C0695D.BUG) {
                Log.d(MediaSessions.TAG, m7cb("onSessionDestroyed"));
            }
        }
    ...
    public MediaSessions(Context context, Looper looper, Callbacks callbacks) {
        ...
        this.mHandler = new C0698H(looper);
