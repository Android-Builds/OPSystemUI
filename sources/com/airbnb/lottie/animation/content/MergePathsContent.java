...
public class MergePathsContent implements PathContent, GreedyContent {
    ...
    static /* synthetic */ class C05341 {
        ...
        static final /* synthetic */ int[] f47x7df623d1 = new int[MergePathsMode.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f47x7df623d1 = r0
                int[] r0 = f47x7df623d1     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f47x7df623d1     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f47x7df623d1     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r0 = f47x7df623d1     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                int[] r0 = f47x7df623d1     // Catch:{ NoSuchFieldError -> 0x0040 }
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.animation.content.MergePathsContent.C05341.<clinit>():void");
        }
    }
    ...
    public Path getPath() {
        ...
        int i = C05341.f47x7df623d1[this.mergePaths.getMode().ordinal()];
        if (i == 1) {
            addPaths();
        } else if (i == 2) {
