...
public class ShapeStroke implements ContentModel {
    ...
    static /* synthetic */ class C05361 {
        ...
        static final /* synthetic */ int[] f48xd9891597 = new int[LineCapType.values().length];

        /* renamed from: $SwitchMap$com$airbnb$lottie$model$content$ShapeStroke$LineJoinType */
        static final /* synthetic */ int[] f49x8c4dd79 = new int[LineJoinType.values().length];
        ...
        static {
            /*
                ...
                f49x8c4dd79 = r0
                r0 = 1
                int[] r1 = f49x8c4dd79     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                r1 = 2
                int[] r2 = f49x8c4dd79     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                r2 = 3
                int[] r3 = f49x8c4dd79     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                ...
                int[] r3 = new int[r3]
                f48xd9891597 = r3
                int[] r3 = f48xd9891597     // Catch:{ NoSuchFieldError -> 0x003d }
            ...
            L_0x003d:
                int[] r0 = f48xd9891597     // Catch:{ NoSuchFieldError -> 0x0047 }
            ...
            L_0x0047:
                int[] r0 = f48xd9891597     // Catch:{ NoSuchFieldError -> 0x0051 }
            ...
            L_0x0051:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.model.content.ShapeStroke.C05361.<clinit>():void");
        }
    }
    ...
    public enum LineCapType {
        ...
        public Cap toPaintCap() {
            int i = C05361.f48xd9891597[ordinal()];
            if (i == 1) {
                return Cap.BUTT;
            }
            if (i != 2) {
    ...
    public enum LineJoinType {
        ...
        public Join toPaintJoin() {
            int i = C05361.f49x8c4dd79[ordinal()];
            if (i == 1) {
                return Join.BEVEL;
            }
            if (i == 2) {
