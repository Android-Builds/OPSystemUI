    ...
    static /* synthetic */ class C05391 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.model.layer.CompositionLayer.C05391.<clinit>():void");
        }
    }
        ...
        while (true) {
            ...
            if (forModel != null) {
                ...
                if (baseLayer != null) {
                    ...
                    int i2 = C05391.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[layer2.getMatteType().ordinal()];
                    if (i2 == 1 || i2 == 2) {
                        baseLayer = forModel;
                    }
                }
