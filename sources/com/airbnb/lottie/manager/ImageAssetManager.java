        ...
        if (!fileName.startsWith("data:") || fileName.indexOf("base64,") <= 0) {
            try {
                if (!TextUtils.isEmpty(this.imagesFolder)) {
                    ...
                    sb.append(this.imagesFolder);
                    sb.append(fileName);
                    Bitmap resizeBitmapIfNeeded = Utils.resizeBitmapIfNeeded(BitmapFactory.decodeStream(assets.open(sb.toString()), null, options), lottieImageAsset.getWidth(), lottieImageAsset.getHeight());
