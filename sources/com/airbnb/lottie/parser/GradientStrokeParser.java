...
class GradientStrokeParser {
    private static final Options DASH_PATTERN_NAMES = Options.m6of("n", "v");
    private static final Options GRADIENT_NAMES = Options.m6of("p", "k");
    private static Options NAMES = Options.m6of("nm", "g", "o", "t", "s", "e", "w", "lc", "lj", "ml", "hd", "d");
