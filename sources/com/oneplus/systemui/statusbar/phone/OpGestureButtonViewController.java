...
public class OpGestureButtonViewController {
    private static final float[] EFFECT_DIST = {0.2f, 0.5f, 0.7f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 0.9f, 0.8f, 0.6f, 0.6f, 0.4f, 0.3f, 0.0f};
    /* access modifiers changed from: private */
    public static float[] sEffectParams = EFFECT_DIST;
    ...
    private class EdgeEffectView extends ImageView {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (!this.mEffect.isFinished() && OpGestureButtonViewController.this.isPortrait()) {
                if (OpGestureButtonViewController.this.mDownPointX < ((float) (OpGestureButtonViewController.this.mScreenWidth / 3))) {
                    i = OpGestureButtonViewController.this.mScreenWidth / 3;
                } else {
                    i = OpGestureButtonViewController.this.mScreenWidth;
                }
                int i2 = -i;
                int i3 = -(OpGestureButtonViewController.this.mScreenWidth / 18);
    ...
    private class OemGestureButtonHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 1) {
                ...
                if (opGestureButtonViewController.mEffectStage <= OpGestureButtonViewController.sEffectParams.length - 1) {
                    ...
                    OpGestureButtonViewController.this.mEffectStage = OpGestureButtonViewController.this.mEffectStage + 1;
    ...
    /* access modifiers changed from: private */
    public void updateGestureButtonRegion() {
        String str = "OpGestureController";
        if (!this.mIsEnabled) {
            ...
            if (edgeEffectView != null) {
                if (edgeEffectView.getParent() != null) {
                    ...
                    if (Build.DEBUG_ONEPLUS) {
                        Log.d(str, "removeView mEdgeEffectView ");
                    }
                }
                this.mEdgeEffectView = null;
                Slog.i(str, "updateGestureButtonRegion: not enabled");
            }
        } else if (this.mEdgeEffectView == null) {
            this.mRegionWindowParams = new LayoutParams(2027);
            LayoutParams layoutParams = this.mRegionWindowParams;
            layoutParams.flags |= 280;
            layoutParams.privateFlags |= 16;
            layoutParams.layoutInDisplayCutoutMode = 1;
            layoutParams.setTitle("GestureButtonRegion");
            LayoutParams layoutParams2 = this.mRegionWindowParams;
            layoutParams2.format = -3;
            layoutParams2.windowAnimations = 16973828;
            updateWindowParams();
            this.mEdgeEffectView = new EdgeEffectView(this.mContext);
            this.mEdgeEffectView.setLayoutParams(this.mRegionWindowParams);
            this.mWm.addView(this.mEdgeEffectView, this.mRegionWindowParams);
            if (Build.DEBUG_ONEPLUS) {
                Log.d(str, "addView mEdgeEffectView ");
            }
        } else {
            if (Build.DEBUG_ONEPLUS) {
                Log.d(str, "update mEdgeEffectView layout");
            }
            updateWindowParams();
    ...
    private void updateWindowParams() {
        if (this.mRegionWindowParams != null) {
            ...
            if (EdgeBackGestureHandler.sSideGestureEnabled) {
                LayoutParams layoutParams3 = this.mRegionWindowParams;
