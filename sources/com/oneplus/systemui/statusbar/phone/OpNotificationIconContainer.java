...
public class OpNotificationIconContainer extends AlphaOptimizedFrameLayout {
    ...
    public void initDimensInternal() {
        this.mIconPadding = getResources().getDimensionPixelSize(R$dimen.status_bar_notification_icon_padding);
    }
    ...
    public void setRemoveWithoutAnimation(boolean z) {
        this.mRemoveWithoutAnimation = z;
    }
}
