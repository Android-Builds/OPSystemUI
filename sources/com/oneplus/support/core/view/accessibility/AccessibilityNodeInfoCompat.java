...
import com.oneplus.support.core.p010os.BuildCompat;
...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            if (VERSION.SDK_INT >= 23) {
                obj2 = AccessibilityAction.ACTION_CONTEXT_CLICK;
            } else {
                obj2 = null;
            }
            ACTION_CONTEXT_CLICK = new AccessibilityActionCompat(obj2);
