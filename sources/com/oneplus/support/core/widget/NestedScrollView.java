...
import com.oneplus.support.core.view.NestedScrollingChild2;
import com.oneplus.support.core.view.NestedScrollingChildHelper;
import com.oneplus.support.core.view.NestedScrollingParent2;
import com.oneplus.support.core.view.NestedScrollingParentHelper;
import com.oneplus.support.core.view.ScrollingView;
...
import com.oneplus.support.core.view.accessibility.AccessibilityRecordCompat;
...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent2, NestedScrollingChild2, ScrollingView {
    ...
    public boolean overScrollByCompat(int r13, int r14, int r15, int r16, int r17, int r18, int r19, int r20, boolean r21) {
        ...
        L_0x0087:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.support.core.widget.NestedScrollView.overScrollByCompat(int, int, int, int, int, int, int, int, boolean):boolean");
    }
