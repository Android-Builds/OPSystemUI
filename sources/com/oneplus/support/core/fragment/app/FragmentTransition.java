...
class FragmentTransition {
    ...
    private static Object configureSharedElementsOrdered(FragmentTransitionImpl fragmentTransitionImpl, ViewGroup viewGroup, View view, ArrayMap<String, String> arrayMap, FragmentContainerTransition fragmentContainerTransition, ArrayList<View> arrayList, ArrayList<View> arrayList2, Object obj, Object obj2) {
        ...
        C20174 r0 = new Runnable() {
            public void run() {
                ArrayMap access$300 = FragmentTransition.captureInSharedElements(FragmentTransitionImpl.this, arrayMap3, obj6, fragmentContainerTransition3);
                if (access$300 != null) {
                ...
                if (obj != null) {
                    ...
                    if (access$400 != null) {
                        FragmentTransitionImpl.this.getBoundsOnScreen(access$400, rect2);
                    }
                }
            }
        };
    ...
    public static void calculateFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            addToFirstInLastOut(backStackRecord, (C1998Op) backStackRecord.mOps.get(i), sparseArray, false, z);
        }
    }
    ...
    public static void calculatePopFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z) {
        if (backStackRecord.mManager.mContainer.onHasView()) {
            for (int size = backStackRecord.mOps.size() - 1; size >= 0; size--) {
                addToFirstInLastOut(backStackRecord, (C1998Op) backStackRecord.mOps.get(size), sparseArray, true, z);
            }
        }
    }
    ...
    private static void addToFirstInLastOut(com.oneplus.support.core.fragment.app.BackStackRecord r16, com.oneplus.support.core.fragment.app.BackStackRecord.C1998Op r17, android.util.SparseArray<com.oneplus.support.core.fragment.app.FragmentTransition.FragmentContainerTransition> r18, boolean r19, boolean r20) {
        /*
            r0 = r16
            r1 = r17
            r2 = r18
            r3 = r19
            com.oneplus.support.core.fragment.app.Fragment r10 = r1.fragment
        ...
        L_0x009c:
            ...
            com.oneplus.support.core.fragment.app.FragmentTransition$FragmentContainerTransition r6 = (com.oneplus.support.core.fragment.app.FragmentTransition.FragmentContainerTransition) r6
            if (r4 == 0) goto L_0x00ae
            com.oneplus.support.core.fragment.app.FragmentTransition$FragmentContainerTransition r6 = ensureContainer(r6, r2, r11)
            r6.lastIn = r10
            r6.lastInIsPop = r3
        ...
        L_0x00ae:
            ...
            com.oneplus.support.core.fragment.app.Fragment r1 = r14.firstOut
            if (r1 != r10) goto L_0x00bc
            r14.firstOut = r15
        L_0x00bc:
            com.oneplus.support.core.fragment.app.FragmentManagerImpl r4 = r0.mManager
            int r1 = r10.mState
        ...
        L_0x00dd:
            com.oneplus.support.core.fragment.app.FragmentTransition$FragmentContainerTransition r14 = ensureContainer(r14, r2, r11)
            r14.firstOut = r10
        ...
        L_0x00e7:
            ...
            com.oneplus.support.core.fragment.app.Fragment r0 = r14.lastIn
            if (r0 != r10) goto L_0x00f3
            r14.lastIn = r15
        L_0x00f3:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.support.core.fragment.app.FragmentTransition.addToFirstInLastOut(com.oneplus.support.core.fragment.app.BackStackRecord, com.oneplus.support.core.fragment.app.BackStackRecord$Op, android.util.SparseArray, boolean, boolean):void");
    }
