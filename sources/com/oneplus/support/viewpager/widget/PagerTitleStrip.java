...
import com.oneplus.support.viewpager.widget.ViewPager.DecorView;
import com.oneplus.support.viewpager.widget.ViewPager.OnAdapterChangeListener;
...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void updateTextPositions(int i, float f, boolean z) {
        ...
        int i16 = this.mGravity & C0526R.styleable.AppCompatTheme_toolbarNavigationButtonStyle;
        if (i16 == 16) {
