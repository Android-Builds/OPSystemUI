...
import com.oneplus.volume.OpOutputChooser.OutputChooserCallback;
import java.util.ArrayList;
import java.util.List;

public class OpVolumeDialogImpl {
    protected int mAccentColor = 0;
    protected OnClickListener mClickOutputChooser;
    ...
    protected OutputChooserCallback mOutputChooserCallback = new OutputChooserCallback() {
        public void onOutputChooserNotifyActiveDeviceChange(int i, int i2, String str, String str2) {
            StringBuilder sb = new StringBuilder();
            sb.append("recevie OutputChooserCallback, deviceInfoType:");
            sb.append(i);
            sb.append(", iconResId:");
            sb.append(i2);
            sb.append(", deviceInfoName:");
            sb.append(str);
            sb.append(", deviceInfoAddress:");
            sb.append(str2);
            Log.i("OpVolumeDialogImpl", sb.toString());
            ...
            sb2.append(str);
            sb2.append(" ");
            deviceInfo.deviceInfoName = sb2.toString();
    ...
    protected class OpHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            if (message.what != 1) {
                ...
                Log.w("OpVolumeDialogImpl", sb.toString());
                return;
            }
    ...
    public void setOpOutputChooserGravityNeedBeforeAnimStart(boolean z) {
        LayoutParams layoutParams = (LayoutParams) this.mOutputChooser.getLayoutParams();
        if (z) {
    ...
    public void setOpOutputChooserVisible(boolean z, boolean z2) {
        if (OpUtils.DEBUG_ONEPLUS) {
            StringBuilder sb = new StringBuilder();
            sb.append("setOpOutputChooserVisible:");
            sb.append(z);
            sb.append(", mOpForceExpandState:");
    ...
    public void setDialogWidthH(int i) {
        ...
        LayoutParams layoutParams2 = (LayoutParams) getDialogView().getLayoutParams();
    ...
    public void updateODIRelatedLayout() {
        ...
        if (isLandscape()) {
            ...
            LayoutParams layoutParams = (LayoutParams) getDialogView().getLayoutParams();
            if (i2 <= 345) {
        ...
        if (this.mODICaptionsView != null) {
            ...
            if (viewGroup != null) {
                ...
                if (dimensionPixelSize > measuredWidth) {
                    StringBuilder sb = new StringBuilder();
                    sb.append("mODICaptionsView odiHeight:");
                    sb.append(dimensionPixelSize);
                    sb.append(" max:");
                    sb.append(measuredWidth);
                    Log.d("OpVolumeDialogImpl", sb.toString());
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ImageButton imageButton = ((VolumeRow) this.mRows.get(i3)).icon;
            if (imageButton != null) {
                ((MarginLayoutParams) imageButton.getLayoutParams()).bottomMargin = dimensionPixelSize3;
            }
        }
    }
    ...
    private CustomDialog getDialog() {
        return (CustomDialog) OpReflectionUtils.getValue(VolumeDialogImpl.class, this, "mDialog");
    }
