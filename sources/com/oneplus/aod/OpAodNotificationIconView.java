...
public class OpAodNotificationIconView extends AnimatedImageView {
    ...
    public boolean set(StatusBarIcon statusBarIcon) {
        ...
        if (!z3) {
            if (Build.DEBUG_ONEPLUS) {
                ...
                sb.append(statusBarIcon.visible);
                sb.append(" mBlocked:");
                sb.append(this.mBlocked);
                Log.i("StatusBarIconView", sb.toString());
            }
    ...
    public static String contentDescForNotification(Context context, Notification notification) {
        ...
        if (TextUtils.isEmpty(charSequence4)) {
            charSequence4 = !TextUtils.isEmpty(charSequence3) ? charSequence3 : charSequence2;
        }
        return context.getString(R$string.accessibility_desc_notification_icon, new Object[]{charSequence, charSequence4});
    }
}
