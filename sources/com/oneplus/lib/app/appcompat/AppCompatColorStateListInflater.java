    ...
    private static ColorStateList inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next != 2 || depth2 > depth || !xmlPullParser.getName().equals("item")) {
                ...
                TypedArray obtainAttributes = obtainAttributes(resources, theme, attributeSet2, R$styleable.OPColorStateListItem);
                int color = obtainAttributes.getColor(R$styleable.OPColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (obtainAttributes.hasValue(R$styleable.OPColorStateListItem_android_alpha)) {
                    f = obtainAttributes.getFloat(R$styleable.OPColorStateListItem_android_alpha, 1.0f);
                } else if (obtainAttributes.hasValue(R$styleable.OPColorStateListItem_alpha)) {
                    f = obtainAttributes.getFloat(R$styleable.OPColorStateListItem_alpha, 1.0f);
                }
