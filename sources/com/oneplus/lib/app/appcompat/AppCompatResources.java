...
public final class AppCompatResources {
    ...
    private static android.content.res.ColorStateList getCachedColorStateList(android.content.Context r4, int r5) {
        /*
            ...
            monitor-enter(r0)
            java.util.WeakHashMap<android.content.Context, android.util.SparseArray<com.oneplus.lib.app.appcompat.AppCompatResources$ColorStateListCacheEntry>> r1 = sColorStateCaches     // Catch:{ all -> 0x0035 }
            ...
            com.oneplus.lib.app.appcompat.AppCompatResources$ColorStateListCacheEntry r2 = (com.oneplus.lib.app.appcompat.AppCompatResources.ColorStateListCacheEntry) r2     // Catch:{ all -> 0x0035 }
            if (r2 == 0) goto L_0x0032
