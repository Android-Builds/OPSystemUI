...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mRemoveActionBarHideOffset = new Runnable() {
            public void run() {
                ...
                ActionBarOverlayLayout actionBarOverlayLayout = ActionBarOverlayLayout.this;
                ViewPropertyAnimatorCompat animate = ViewCompat.animate(actionBarOverlayLayout.mActionBarTop);
                animate.translationY(0.0f);
                animate.setListener(ActionBarOverlayLayout.this.mTopAnimatorListener);
                actionBarOverlayLayout.mCurrentActionBarTopAnimator = animate;
            }
        };
        this.mAddActionBarHideOffset = new Runnable() {
            public void run() {
                ...
                ActionBarOverlayLayout actionBarOverlayLayout = ActionBarOverlayLayout.this;
                ViewPropertyAnimatorCompat animate = ViewCompat.animate(actionBarOverlayLayout.mActionBarTop);
                animate.translationY((float) (-ActionBarOverlayLayout.this.mActionBarTop.getHeight()));
                animate.setListener(ActionBarOverlayLayout.this.mTopAnimatorListener);
                actionBarOverlayLayout.mCurrentActionBarTopAnimator = animate;
            }
        };
    ...
    private boolean applyInsets(android.view.View r2, android.graphics.Rect r3, boolean r4, boolean r5, boolean r6, boolean r7) {
        /*
            ...
            com.oneplus.lib.app.appcompat.ActionBarOverlayLayout$LayoutParams r1 = (com.oneplus.lib.app.appcompat.ActionBarOverlayLayout.LayoutParams) r1
            r2 = 1
        ...
        L_0x0036:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.app.appcompat.ActionBarOverlayLayout.applyInsets(android.view.View, android.graphics.Rect, boolean, boolean, boolean, boolean):boolean");
    }
