...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        if (VERSION.SDK_INT >= 21) {
            drawable = new ActionBarBackgroundDrawableV21(this);
        } else {
            drawable = new ActionBarBackgroundDrawable(this);
        }
    ...
    public void onLayout(boolean r6, int r7, int r8, int r9, int r10) {
        ...
        L_0x00c5:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.app.appcompat.ActionBarContainer.onLayout(boolean, int, int, int, int):void");
    }
}
