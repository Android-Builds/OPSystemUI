...
import com.oneplus.lib.app.appcompat.TooltipCompat;
...
import com.oneplus.support.core.view.PointerIconCompat;
...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.defaultMargin = resources.getDimensionPixelSize(R$dimen.design_bottom_navigation_margin_top);
            ...
            if (i != 0) {
                ...
                if (i != 1) {
                    if (i == 2) {
                        ...
                        setViewLayoutParams(imageView, i3, i2);
