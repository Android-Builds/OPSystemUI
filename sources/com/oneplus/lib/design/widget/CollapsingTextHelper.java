...
import com.oneplus.support.core.text.TextDirectionHeuristicCompat;
import com.oneplus.support.core.text.TextDirectionHeuristicsCompat;
...
final class CollapsingTextHelper {
    ...
    public void setCollapsedTextAppearance(int i) {
        TypedArray obtainStyledAttributes = this.mView.getContext().obtainStyledAttributes(i, R$styleable.OpTextAppearance);
        if (obtainStyledAttributes.hasValue(R$styleable.OpTextAppearance_android_textColor)) {
            this.mCollapsedTextColor = obtainStyledAttributes.getColorStateList(R$styleable.OpTextAppearance_android_textColor);
        }
        if (obtainStyledAttributes.hasValue(R$styleable.OpTextAppearance_android_textSize)) {
            this.mCollapsedTextSize = (float) obtainStyledAttributes.getDimensionPixelSize(R$styleable.OpTextAppearance_android_textSize, (int) this.mCollapsedTextSize);
        }
        this.mCollapsedShadowColor = obtainStyledAttributes.getInt(R$styleable.OpTextAppearance_android_shadowColor, 0);
        this.mCollapsedShadowDx = obtainStyledAttributes.getFloat(R$styleable.OpTextAppearance_android_shadowDx, 0.0f);
        this.mCollapsedShadowDy = obtainStyledAttributes.getFloat(R$styleable.OpTextAppearance_android_shadowDy, 0.0f);
        this.mCollapsedShadowRadius = obtainStyledAttributes.getFloat(R$styleable.OpTextAppearance_android_shadowRadius, 0.0f);
    ...
    public void setExpandedTextAppearance(int i) {
        TypedArray obtainStyledAttributes = this.mView.getContext().obtainStyledAttributes(i, R$styleable.OpTextAppearance);
        if (obtainStyledAttributes.hasValue(R$styleable.OpTextAppearance_android_textColor)) {
            this.mExpandedTextColor = obtainStyledAttributes.getColorStateList(R$styleable.OpTextAppearance_android_textColor);
        }
        if (obtainStyledAttributes.hasValue(R$styleable.OpTextAppearance_android_textSize)) {
            this.mExpandedTextSize = (float) obtainStyledAttributes.getDimensionPixelSize(R$styleable.OpTextAppearance_android_textSize, (int) this.mExpandedTextSize);
        }
        this.mExpandedShadowColor = obtainStyledAttributes.getInt(R$styleable.OpTextAppearance_android_shadowColor, 0);
        this.mExpandedShadowDx = obtainStyledAttributes.getFloat(R$styleable.OpTextAppearance_android_shadowDx, 0.0f);
        this.mExpandedShadowDy = obtainStyledAttributes.getFloat(R$styleable.OpTextAppearance_android_shadowDy, 0.0f);
        this.mExpandedShadowRadius = obtainStyledAttributes.getFloat(R$styleable.OpTextAppearance_android_shadowRadius, 0.0f);
        obtainStyledAttributes.recycle();
        if (VERSION.SDK_INT >= 16) {
    ...
    private void calculateBaseOffsets() {
        ...
        int i = absoluteGravity & C0526R.styleable.AppCompatTheme_toolbarNavigationButtonStyle;
        if (i == 48) {
        ...
        int i3 = absoluteGravity2 & C0526R.styleable.AppCompatTheme_toolbarNavigationButtonStyle;
        if (i3 == 48) {
