...
public class ViewUtilsLollipop {
    ...
    public static void setDefaultAppBarLayoutStateListAnimator(View view, float f) {
        ...
        long j = (long) integer;
        stateListAnimator.addState(new int[]{16842766, R$attr.op_state_collapsible, -R$attr.op_state_collapsed}, ObjectAnimator.ofFloat(view, str, new float[]{0.0f}).setDuration(j));
