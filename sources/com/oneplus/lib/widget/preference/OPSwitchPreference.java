...
public class OPSwitchPreference extends SwitchPreference {
    ...
    public OPSwitchPreference(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, R$style.OnePlus_DeviceDefault_Preference_Material_SwitchPreference);
    }

    public OPSwitchPreference(Context context, AttributeSet attributeSet, int i, int i2) {
