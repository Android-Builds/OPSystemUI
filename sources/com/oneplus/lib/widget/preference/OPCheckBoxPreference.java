...
public class OPCheckBoxPreference extends CheckBoxPreference {
    ...
    public OPCheckBoxPreference(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, R$style.OnePlus_DeviceDefault_Preference_Material_CheckBoxPreference);
    }

    public OPCheckBoxPreference(Context context, AttributeSet attributeSet, int i, int i2) {
