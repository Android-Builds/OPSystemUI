...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean z) {
        this(toolbar, z, 0, R$drawable.abc_ic_ab_back_material);
    }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean z, int i, int i2) {
        ...
        if (z) {
            ...
            setDisplayOptions(obtainStyledAttributes.getInt(R$styleable.ActionBar_op_displayOptions, 0));
            ...
            int resourceId4 = obtainStyledAttributes.getResourceId(R$styleable.ActionBar_android_popupTheme, 0);
            if (resourceId4 != 0) {
