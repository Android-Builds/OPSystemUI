...
public class NumberPicker extends LinearLayout {
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
        ...
        private String getVirtualDecrementButtonText() {
            ...
            if (NumberPicker.this.mDisplayedValues == null) {
                str = NumberPicker.this.formatNumber(access$1800);
            } else {
                str = NumberPicker.this.mDisplayedValues[access$1800 - NumberPicker.this.mMinValue];
            }
            return str;
        }
    ...
    class InputTextFilter extends NumberKeyListener {
        ...
        public CharSequence filter(CharSequence charSequence, int i, int i2, Spanned spanned, int i3, int i4) {
            ...
            if (NumberPicker.this.mDisplayedValues == null) {
                ...
                return (NumberPicker.this.getSelectedPos(sb2) > NumberPicker.this.mMaxValue || sb2.length() > String.valueOf(NumberPicker.this.mMaxValue).length()) ? str : filter;
            }
    ...
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r2v2, types: [boolean, byte]
      assigns: [byte]
      uses: [boolean]
      mth insns count: 5
    ...
    static /* synthetic */ boolean access$1280(com.oneplus.lib.widget.NumberPicker r1, int r2) {
        /*
            boolean r0 = r1.mIncrementVirtualButtonPressed
            r2 = r2 ^ r0
            byte r2 = (byte) r2
            r1.mIncrementVirtualButtonPressed = r2
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.widget.NumberPicker.access$1280(com.oneplus.lib.widget.NumberPicker, int):boolean");
    }
    ...
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ boolean access$1480(com.oneplus.lib.widget.NumberPicker r1, int r2) {
        /*
            boolean r0 = r1.mDecrementVirtualButtonPressed
            r2 = r2 ^ r0
            byte r2 = (byte) r2
            r1.mDecrementVirtualButtonPressed = r2
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.widget.NumberPicker.access$1480(com.oneplus.lib.widget.NumberPicker, int):boolean");
    }
    ...
    public NumberPicker(Context context, AttributeSet attributeSet, int i) {
        ...
        int resourceId = obtainStyledAttributes.getResourceId(R$styleable.NumberPicker_internalLayout, DEFAULT_LAYOUT_RESOURCE_ID);
        this.mHasSelectorWheel = resourceId != DEFAULT_LAYOUT_RESOURCE_ID;
        ...
        C18852 r9 = new OnLongClickListener() {
        ...
        if (!this.mHasSelectorWheel) {
            ...
            this.mIncrementButton.setOnClickListener(r8);
        ...
        if (!this.mHasSelectorWheel) {
            ...
            this.mDecrementButton.setOnClickListener(r8);
