...
public class TextInputTimePickerView extends RelativeLayout {
    ...
    public final EditText mHourEditText;
    ...
    public TextInputTimePickerView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        int i3 = R$attr.opPickerColorUnActivated;
        int[] iArr = {i3, R$attr.opPickerInputLabelUnActivated};
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, new int[]{R$attr.opPickerColorActivated, i3});
    ...
    public void setHourFormat(int i) {
        this.mHourEditText.setFilters(new InputFilter[]{new LengthFilter(i)});
        this.mMinuteEditText.setFilters(new InputFilter[]{new LengthFilter(i)});
    }
    ...
    public void updateTextInputValues(int i, int i2, int i3, boolean z, boolean z2) {
        ...
        String str = "%d";
        this.mHourEditText.setText(String.format(str, objArr));
        this.mMinuteEditText.setText(String.format(str, new Object[]{Integer.valueOf(i2)}));
    ...
    private boolean isValidLocalizedHour(int i) {
        int i2 = !this.mHourFormatStartsAtZero;
