...
public class DefaultItemAnimator extends ItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z2) {
                ...
                if (z) {
                    ((MoveInfo) arrayList.get(0)).holder.itemView.postOnAnimationDelayed(r6, getRemoveDuration());
                } else {
                    r6.run();
                }
            }
            if (z3) {
                ...
                if (z) {
                    ((ChangeInfo) arrayList2.get(0)).oldHolder.itemView.postOnAnimationDelayed(r62, getRemoveDuration());
                } else {
                    r62.run();
                }
            }
            if (z4) {
                ...
                if (z || z2 || z3) {
                    ...
                    ((ViewHolder) arrayList3.get(0)).itemView.postOnAnimationDelayed(r5, removeDuration + Math.max(moveDuration, j));
                } else {
                    r5.run();
                }
            }
    ...
    public boolean animateMove(ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        ...
        int translationX = (int) (((float) i) + view.getTranslationX());
    ...
    public void animateMoveImpl(ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        ...
        C19506 r0 = new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
    ...
    public void endAnimation(ViewHolder viewHolder) {
        ...
        } else if (this.mAddAnimations.remove(viewHolder)) {
            throw new IllegalStateException("after animation is cancelled, item should not be in mAddAnimations list");
        } else if (this.mChangeAnimations.remove(viewHolder)) {
            throw new IllegalStateException("after animation is cancelled, item should not be in mChangeAnimations list");
        } else if (!this.mMoveAnimations.remove(viewHolder)) {
