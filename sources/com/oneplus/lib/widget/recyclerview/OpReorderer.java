...
class OpReorderer {
    ...
    public void swapMoveRemove(List<UpdateOp> list, int i, UpdateOp updateOp, int i2, UpdateOp updateOp2) {
        ...
        if (i8 <= i9) {
            ...
            if (i8 < i9 + i10) {
                updateOp3 = this.mCallback.obtainUpdateOp(1, i8 + 1, (i9 + i10) - i8, null);
    ...
    public void swapMoveUpdate(java.util.List<com.oneplus.lib.widget.recyclerview.AdapterHelper.UpdateOp> r9, int r10, com.oneplus.lib.widget.recyclerview.AdapterHelper.UpdateOp r11, int r12, com.oneplus.lib.widget.recyclerview.AdapterHelper.UpdateOp r13) {
        /*
            r8 = this;
        ...
        L_0x000d:
            ...
            int r5 = r5 - r4
            r13.itemCount = r5
            com.oneplus.lib.widget.recyclerview.OpReorderer$Callback r0 = r8.mCallback
            int r1 = r11.positionStart
            java.lang.Object r5 = r13.payload
            com.oneplus.lib.widget.recyclerview.AdapterHelper$UpdateOp r0 = r0.obtainUpdateOp(r2, r1, r4, r5)
            goto L_0x0021
        L_0x0020:
            r0 = r3
        L_0x0021:
        ...
        L_0x002b:
            ...
            int r5 = r5 + r6
            int r5 = r5 - r1
            com.oneplus.lib.widget.recyclerview.OpReorderer$Callback r3 = r8.mCallback
            int r1 = r1 + r4
            java.lang.Object r4 = r13.payload
            com.oneplus.lib.widget.recyclerview.AdapterHelper$UpdateOp r3 = r3.obtainUpdateOp(r2, r1, r5, r4)
        ...
        L_0x004c:
            r9.remove(r10)
            com.oneplus.lib.widget.recyclerview.OpReorderer$Callback r8 = r8.mCallback
        ...
        L_0x005e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.widget.recyclerview.OpReorderer.swapMoveUpdate(java.util.List, int, com.oneplus.lib.widget.recyclerview.AdapterHelper$UpdateOp, int, com.oneplus.lib.widget.recyclerview.AdapterHelper$UpdateOp):void");
    }
